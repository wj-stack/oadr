...
#ifndef KEY_VALUE_TYPE_HXX
#define KEY_VALUE_TYPE_HXX
...
namespace oadr2b
{
  namespace sig
  {
    class KeyValueType: public ::xml_schema_test::type
    {
      public:
      // DSAKeyValue
      //
      typedef ::oadr2b::sig::DSAKeyValueType DSAKeyValue_type;
      ...
      // RSAKeyValue
      //
      typedef ::oadr2b::sig::RSAKeyValueType RSAKeyValue_type;
