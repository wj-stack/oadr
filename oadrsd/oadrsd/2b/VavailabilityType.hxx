...
#ifndef VAVAILABILITY_TYPE_HXX
#define VAVAILABILITY_TYPE_HXX
...
namespace icalendar_2_0
{
  class VavailabilityType: public ::xml_schema_test::type
  {
    public:
    // components
    //
    typedef ::icalendar_2_0::ArrayOfVavailabilityContainedComponents components_type;
    ...
    // Constructors.
    //
    VavailabilityType (const components_type&);

    VavailabilityType (::std::unique_ptr< components_type >);
...
{
  void
  operator<< (::xercesc::DOMElement&, const VavailabilityType&);
}
