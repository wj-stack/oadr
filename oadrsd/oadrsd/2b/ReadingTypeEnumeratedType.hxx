...
#ifndef READING_TYPE_ENUMERATED_TYPE_HXX
#define READING_TYPE_ENUMERATED_TYPE_HXX
...
namespace oadr2b
{
  namespace ei
  {
    class ReadingTypeEnumeratedType: public ::xml_schema_test::token
    {
      public:
      enum value
      {
      ...
      ReadingTypeEnumeratedType (const  ::xml_schema_test::token& v);
      ...
      ReadingTypeEnumeratedType (const ReadingTypeEnumeratedType& x,
                            ::xml_schema_test::flags f = 0,
                            ::xml_schema_test::container* c = 0);

      virtual ReadingTypeEnumeratedType*
      ...
      {
        return _xsd_ReadingTypeEnumeratedType_convert ();
      }
      ...
      public:
      static const char* const _xsd_ReadingTypeEnumeratedType_literals_[13];
      static const value _xsd_ReadingTypeEnumeratedType_indexes_[13];
    };
  }
}
...
namespace oadr2b
{
  ...
  {
    void
    operator<< (::xercesc::DOMElement&, const ReadingTypeEnumeratedType&);

    void
    operator<< (::xercesc::DOMAttr&, const ReadingTypeEnumeratedType&);

    void
    operator<< (::xml_schema_test::list_stream&,
                const ReadingTypeEnumeratedType&);
  }
}
...
#endif // READING_TYPE_ENUMERATED_TYPE_HXX
