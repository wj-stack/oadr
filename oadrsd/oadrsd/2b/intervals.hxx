...
#ifndef INTERVALS_HXX
#define INTERVALS_HXX
...
namespace stream
{
  class intervals: public ::xml_schema_test::type
  {
    public:
    // interval
    //
    typedef ::oadr2b::ei::IntervalType interval_type;
    typedef ::xsd::cxx::tree::sequence< interval_type > interval_sequence;
    typedef interval_sequence::iterator interval_iterator;
    typedef interval_sequence::const_iterator interval_const_iterator;
...
{
  void
  operator<< (::xercesc::DOMElement&, const intervals&);
}
