...
#ifndef NODE_TYPE_HXX
#define NODE_TYPE_HXX
...
namespace power
{
  class NodeType: public ::xml_schema_test::string
  {
    public:
    // Constructors.
    //
    ...
    NodeType (const ::std::string&);

    NodeType (const  ::xml_schema_test::string&);
...
namespace power
{
  ...
  void
  operator<< (::xercesc::DOMAttr&, const NodeType&);
