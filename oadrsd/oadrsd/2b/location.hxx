...
namespace oadr2b
{
  namespace gml
  {
    class location: public ::xml_schema_test::type
    {
      public:
      // Polygon
      //
      typedef ::oadr2b::gml::Polygon Polygon_type;
      ...
      void
      Polygon (::std::unique_ptr< Polygon_type > p);

      // Constructors.
      //
      location (const Polygon_type&);

      location (::std::unique_ptr< Polygon_type >);
      ...
      protected:
      ::xsd::cxx::tree::one< Polygon_type > Polygon_;
    };
  }
}
