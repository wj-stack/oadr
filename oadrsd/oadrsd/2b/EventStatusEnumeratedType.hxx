...
#ifndef EVENT_STATUS_ENUMERATED_TYPE_HXX
#define EVENT_STATUS_ENUMERATED_TYPE_HXX
...
namespace oadr2b
{
  namespace ei
  {
    class EventStatusEnumeratedType: public ::xml_schema_test::token
    {
      public:
      enum value
      {
      ...
      EventStatusEnumeratedType (const EventStatusEnumeratedType& x,
                            ::xml_schema_test::flags f = 0,
                            ::xml_schema_test::container* c = 0);

      virtual EventStatusEnumeratedType*
      ...
      {
        return _xsd_EventStatusEnumeratedType_convert ();
      }
      ...
      public:
      static const char* const _xsd_EventStatusEnumeratedType_literals_[6];
      static const value _xsd_EventStatusEnumeratedType_indexes_[6];
    };
  }
}
...
namespace oadr2b
{
  ...
  {
    void
    operator<< (::xercesc::DOMElement&, const EventStatusEnumeratedType&);

    void
    operator<< (::xercesc::DOMAttr&, const EventStatusEnumeratedType&);
...
#endif // EVENT_STATUS_ENUMERATED_TYPE_HXX
