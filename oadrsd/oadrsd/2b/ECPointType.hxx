...
#ifndef ECPOINT_TYPE_HXX
#define ECPOINT_TYPE_HXX
...
namespace oadr2b
{
  namespace dsig11
  {
    class ECPointType: public ::oadr2b::sig::CryptoBinary
    {
      public:
      // Constructors.
      //
      ...
      ECPointType (const  ::xml_schema_test::base64_binary&);
...
namespace oadr2b
{
  ...
  {
    void
    operator<< (::xercesc::DOMElement&, const ECPointType&);

    void
    operator<< (::xercesc::DOMAttr&, const ECPointType&);
