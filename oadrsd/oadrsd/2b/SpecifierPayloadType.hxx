...
#ifndef SPECIFIER_PAYLOAD_TYPE_HXX
#define SPECIFIER_PAYLOAD_TYPE_HXX
...
namespace oadr2b
{
  namespace ei
  {
    class SpecifierPayloadType: public ::xml_schema_test::type
    {
      public:
      // rID
      //
      ...
      // Constructors.
      //
      SpecifierPayloadType (const rID_type&,
                            const readingType_type&);
...
namespace oadr2b
{
  ...
  {
    void
    operator<< (::xercesc::DOMElement&, const SpecifierPayloadType&);
  }
}
...
#endif // SPECIFIER_PAYLOAD_TYPE_HXX
