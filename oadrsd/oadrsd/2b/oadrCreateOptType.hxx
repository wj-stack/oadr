...
#ifndef OADR_CREATE_OPT_TYPE_HXX
#define OADR_CREATE_OPT_TYPE_HXX
...
namespace oadr2b
{
  namespace oadr
  {
    class oadrCreateOptType: public ::oadr2b::ei::EiOptType
    {
      public:
      // requestID
      //
      ...
      typedef ::xsd::cxx::tree::optional< qualifiedEventID_type > qualifiedEventID_optional;
      typedef ::xsd::cxx::tree::traits< qualifiedEventID_type, char > qualifiedEventID_traits;

      const qualifiedEventID_optional&
      qualifiedEventID () const;

      qualifiedEventID_optional&
      qualifiedEventID ();
      ...
      // oadrDeviceClass
      //
      typedef ::oadr2b::ei::EiTargetType oadrDeviceClass_type;
      typedef ::xsd::cxx::tree::optional< oadrDeviceClass_type > oadrDeviceClass_optional;
      typedef ::xsd::cxx::tree::traits< oadrDeviceClass_type, char > oadrDeviceClass_traits;

      const oadrDeviceClass_optional&
      oadrDeviceClass () const;

      oadrDeviceClass_optional&
      oadrDeviceClass ();
      ...
      void
      oadrDeviceClass (::std::unique_ptr< oadrDeviceClass_type > p);

      // Constructors.
      //
      oadrCreateOptType (const optID_type&,
                         const optType_type&,
      ...
      qualifiedEventID_optional qualifiedEventID_;
      ::xsd::cxx::tree::one< eiTarget_type > eiTarget_;
      oadrDeviceClass_optional oadrDeviceClass_;
    };
  }
}
...
namespace oadr2b
{
  ...
  {
    void
    operator<< (::xercesc::DOMElement&, const oadrCreateOptType&);
  }
}
...
#endif // OADR_CREATE_OPT_TYPE_HXX
