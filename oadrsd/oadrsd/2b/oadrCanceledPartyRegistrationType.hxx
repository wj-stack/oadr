...
#ifndef OADR_CANCELED_PARTY_REGISTRATION_TYPE_HXX
#define OADR_CANCELED_PARTY_REGISTRATION_TYPE_HXX
...
namespace oadr2b
{
  namespace oadr
  {
    class oadrCanceledPartyRegistrationType: public ::xml_schema_test::type
    {
      public:
      // eiResponse
      //
      ...
      // Constructors.
      //
      oadrCanceledPartyRegistrationType (const eiResponse_type&);
      ...
      virtual oadrCanceledPartyRegistrationType*
...
namespace oadr2b
{
  ...
  {
    void
    operator<< (::xercesc::DOMElement&, const oadrCanceledPartyRegistrationType&);
  }
}
...
#endif // OADR_CANCELED_PARTY_REGISTRATION_TYPE_HXX
