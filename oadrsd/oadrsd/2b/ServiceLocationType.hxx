...
#ifndef SERVICE_LOCATION_TYPE_HXX
#define SERVICE_LOCATION_TYPE_HXX
...
namespace power
{
  class ServiceLocationType: public ::xml_schema_test::type
  {
    public:
    // FeatureCollection
    //
    ...
    // Constructors.
    //
    ServiceLocationType (const FeatureCollection_type&);

    ServiceLocationType (::std::unique_ptr< FeatureCollection_type >);
...
{
  void
  operator<< (::xercesc::DOMElement&, const ServiceLocationType&);
}
...
#endif // SERVICE_LOCATION_TYPE_HXX
