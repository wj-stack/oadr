...
#ifndef X509ISSUER_SERIAL_TYPE_HXX
#define X509ISSUER_SERIAL_TYPE_HXX
...
namespace oadr2b
{
  namespace sig
  {
    class X509IssuerSerialType: public ::xml_schema_test::type
    {
      public:
      // X509IssuerName
      //
      typedef ::xml_schema_test::string X509IssuerName_type;
      ...
      // X509SerialNumber
      //
      typedef ::xml_schema_test::integer X509SerialNumber_type;
...
#endif // X509ISSUER_SERIAL_TYPE_HXX
