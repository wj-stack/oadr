...
#ifndef REPORT_TYPE_TYPE_HXX
#define REPORT_TYPE_TYPE_HXX
...
namespace oadr2b
{
  namespace ei
  {
    class ReportTypeType: public ::xml_schema_test::string
    {
      public:

      ReportTypeType (const char* v);

      ReportTypeType (const ::std::string& v);
      ...
      ReportTypeType (const ReportTypeType& x,
                 ::xml_schema_test::flags f = 0,
                 ::xml_schema_test::container* c = 0);

      virtual ReportTypeType*
...
namespace oadr2b
{
  ...
  {
    void
    operator<< (::xercesc::DOMElement&, const ReportTypeType&);

    void
    operator<< (::xercesc::DOMAttr&, const ReportTypeType&);

    void
    operator<< (::xml_schema_test::list_stream&,
                const ReportTypeType&);
  }
}
