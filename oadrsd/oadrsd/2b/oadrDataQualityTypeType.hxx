...
#ifndef OADR_DATA_QUALITY_TYPE_TYPE_HXX
...
namespace oadr2b
{
  namespace oadr
  {
    class oadrDataQualityTypeType: public ::xml_schema_test::string
    {
      public:

      oadrDataQualityTypeType (const char* v);

      oadrDataQualityTypeType (const ::std::string& v);

      oadrDataQualityTypeType (const ::xercesc::DOMElement& e,
                          ::xml_schema_test::flags f = 0,
                          ::xml_schema_test::container* c = 0);

      oadrDataQualityTypeType (const ::xercesc::DOMAttr& a,
                          ::xml_schema_test::flags f = 0,
                          ::xml_schema_test::container* c = 0);

      oadrDataQualityTypeType (const ::std::string& s,
                               const ::xercesc::DOMElement* e,
                          ::xml_schema_test::flags f = 0,
                          ::xml_schema_test::container* c = 0);

      oadrDataQualityTypeType (const oadrDataQualityTypeType& x,
                          ::xml_schema_test::flags f = 0,
                          ::xml_schema_test::container* c = 0);

      virtual oadrDataQualityTypeType*
...
namespace oadr2b
{
  ...
  {
    void
    operator<< (::xercesc::DOMElement&, const oadrDataQualityTypeType&);

    void
    operator<< (::xercesc::DOMAttr&, const oadrDataQualityTypeType&);

    void
    operator<< (::xml_schema_test::list_stream&,
                const oadrDataQualityTypeType&);
  }
}
...
#endif // OADR_DATA_QUALITY_TYPE_TYPE_HXX
