...
#ifndef OADR_PAYLOAD_HXX
#define OADR_PAYLOAD_HXX
...
namespace oadr2b
{
  namespace oadr
  {
    class oadrPayload: public ::xml_schema_test::type
    {
      public:
      // Signature
      //
      typedef ::oadr2b::sig::SignatureType Signature_type;
      ...
      // oadrSignedObject
      //
      typedef ::oadr2b::oadr::oadrSignedObject oadrSignedObject_type;
      typedef ::xsd::cxx::tree::traits< oadrSignedObject_type, char > oadrSignedObject_traits;

      const oadrSignedObject_type&
      oadrSignedObject () const;

      oadrSignedObject_type&
      oadrSignedObject ();
      ...
      void
      oadrSignedObject (::std::unique_ptr< oadrSignedObject_type > p);

      // Constructors.
      //
      oadrPayload (const oadrSignedObject_type&);

      oadrPayload (::std::unique_ptr< oadrSignedObject_type >);
      ...
      ::xsd::cxx::tree::one< oadrSignedObject_type > oadrSignedObject_;
    };
  }
}
...
namespace oadr2b
{
  ...
  {
    void
    operator<< (::xercesc::DOMElement&, const oadrPayload&);
  }
}
