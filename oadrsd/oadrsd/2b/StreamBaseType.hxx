...
#ifndef STREAM_BASE_TYPE_HXX
#define STREAM_BASE_TYPE_HXX
...
namespace stream
{
  class StreamBaseType: public ::xml_schema_test::type
  {
    public:
    // dtstart
    //
    ...
    typedef ::xsd::cxx::tree::optional< intervals_type > intervals_optional;
    typedef ::xsd::cxx::tree::traits< intervals_type, char > intervals_traits;

    const intervals_optional&
    intervals () const;
...
{
  void
  operator<< (::xercesc::DOMElement&, const StreamBaseType&);
}
