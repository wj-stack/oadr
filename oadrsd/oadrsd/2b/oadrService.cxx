...
namespace oadr2b
{
  namespace oadr
  {
    ...
    void oadrService::
    oadrServiceName (::std::unique_ptr< oadrServiceName_type > x)
    {
      this->oadrServiceName_.set (std::move (x));
    }
  ...
  namespace oadr
  {
      ...
      ::xml_schema_test::flags f)
    {
      for (; p.more_content (); p.next_content (false))
      {
        ...
        // oadrServiceName
        //
        if (n.name () == "oadrServiceName" && n.namespace_ () == "http://openadr.org/oadr-2.0b/2012/07")
        {
          ::std::unique_ptr< oadrServiceName_type > r (
            oadrServiceName_traits::create (i, f, this));

          if (!oadrServiceName_.present ())
          {
            this->oadrServiceName_.set (::std::move (r));
            continue;
          }
        }
