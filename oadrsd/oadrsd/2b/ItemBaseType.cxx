...
namespace oadr2b
{
  namespace emix
  {
    ...
    static
    const ::xsd::cxx::tree::type_factory_initializer< 0, char, ItemBaseType >
    _xsd_ItemBaseType_type_factory_init (
      "ItemBaseType",
...
namespace oadr2b
{
  namespace emix
  {
    ...
    void
    operator<< (::xercesc::DOMAttr&, const ItemBaseType&)
    {
    }
    ...
    static
    const ::xsd::cxx::tree::type_serializer_initializer< 0, char, ItemBaseType >
    _xsd_ItemBaseType_type_serializer_init (
      "ItemBaseType",
      "http://docs.oasis-open.org/ns/emix/2011/06");
  }
}
