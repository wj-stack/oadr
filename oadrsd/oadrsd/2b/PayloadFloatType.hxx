...
#ifndef PAYLOAD_FLOAT_TYPE_HXX
#define PAYLOAD_FLOAT_TYPE_HXX
...
namespace oadr2b
{
  namespace ei
  {
    class PayloadFloatType: public ::oadr2b::ei::PayloadBaseType
    {
      public:
      // value
      //
      typedef ::xml_schema_test::float_ value_type;
      ...
      // Constructors.
      //
      PayloadFloatType (const value_type&);
...
namespace oadr2b
{
  ...
  {
    void
    operator<< (::xercesc::DOMElement&, const PayloadFloatType&);
  }
}
