...
#ifndef REPORT_NAME_ENUMERATED_TYPE_HXX
#define REPORT_NAME_ENUMERATED_TYPE_HXX
...
namespace oadr2b
{
  namespace ei
  {
    class reportNameEnumeratedType: public ::xml_schema_test::token
    {
      public:
      enum value
      {
      ...
      reportNameEnumeratedType (const  ::xml_schema_test::token& v);
      ...
      reportNameEnumeratedType (const reportNameEnumeratedType& x,
                           ::xml_schema_test::flags f = 0,
                           ::xml_schema_test::container* c = 0);

      virtual reportNameEnumeratedType*
      ...
      {
        return _xsd_reportNameEnumeratedType_convert ();
      }
      ...
      public:
      static const char* const _xsd_reportNameEnumeratedType_literals_[8];
      static const value _xsd_reportNameEnumeratedType_indexes_[8];
    };
  }
}
...
namespace oadr2b
{
  ...
  {
    void
    operator<< (::xercesc::DOMElement&, const reportNameEnumeratedType&);

    void
    operator<< (::xercesc::DOMAttr&, const reportNameEnumeratedType&);

    void
    operator<< (::xml_schema_test::list_stream&,
                const reportNameEnumeratedType&);
  }
}
...
#endif // REPORT_NAME_ENUMERATED_TYPE_HXX
