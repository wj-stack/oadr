...
#ifndef AVAILABLE_TYPE_HXX
#define AVAILABLE_TYPE_HXX
...
namespace icalendar_2_0
{
  class AvailableType: public ::xml_schema_test::type
  {
    public:
    // properties
    //
    ...
    // Constructors.
    //
    AvailableType (const properties_type&);

    AvailableType (::std::unique_ptr< properties_type >);
...
{
  void
  operator<< (::xercesc::DOMElement&, const AvailableType&);
}
