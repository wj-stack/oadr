...
#ifndef EI_OPT_TYPE_HXX
#define EI_OPT_TYPE_HXX
...
namespace oadr2b
{
  namespace ei
  {
    class EiOptType: public ::xml_schema_test::type
    {
      public:
      // optID
      //
      typedef ::xml_schema_test::string optID_type;
      typedef ::xsd::cxx::tree::traits< optID_type, char > optID_traits;
      ...
      void
      optID (::std::unique_ptr< optID_type > p);

      // optType
      //
      typedef ::oadr2b::ei::OptTypeType optType_type;
      typedef ::xsd::cxx::tree::traits< optType_type, char > optType_traits;
      ...
      void
      optType (::std::unique_ptr< optType_type > p);

      // optReason
      //
      typedef ::oadr2b::ei::OptReasonType optReason_type;
      typedef ::xsd::cxx::tree::traits< optReason_type, char > optReason_traits;
      ...
      void
      optReason (::std::unique_ptr< optReason_type > p);
      ...
      // vavailability
      //
      typedef ::icalendar_2_0::VavailabilityType vavailability_type;
      typedef ::xsd::cxx::tree::optional< vavailability_type > vavailability_optional;
      typedef ::xsd::cxx::tree::traits< vavailability_type, char > vavailability_traits;

      const vavailability_optional&
      vavailability () const;

      vavailability_optional&
      vavailability ();
      ...
      void
      vavailability (::std::unique_ptr< vavailability_type > p);
      ...
      protected:
      ::xsd::cxx::tree::one< optID_type > optID_;
      ::xsd::cxx::tree::one< optType_type > optType_;
      ::xsd::cxx::tree::one< optReason_type > optReason_;
      marketContext_optional marketContext_;
      ::xsd::cxx::tree::one< venID_type > venID_;
      vavailability_optional vavailability_;
...
namespace oadr2b
{
  ...
  {
    void
    operator<< (::xercesc::DOMElement&, const EiOptType&);
  }
}
