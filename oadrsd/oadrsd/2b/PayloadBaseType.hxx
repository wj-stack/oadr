...
#ifndef PAYLOAD_BASE_TYPE_HXX
#define PAYLOAD_BASE_TYPE_HXX
...
namespace oadr2b
{
  namespace ei
  {
    class PayloadBaseType: public ::xml_schema_test::type
    {
      public:
      // Constructors.
      //
...
namespace oadr2b
{
  ...
  {
    void
    operator<< (::xercesc::DOMElement&, const PayloadBaseType&);
