...
namespace oadr2b
{
  namespace ei
  {
    class UidType: public ::xml_schema_test::string
    {
      public:
      // Constructors.
      //
      ...
      UidType (const ::std::string&);

      UidType (const  ::xml_schema_test::string&);
...
namespace oadr2b
{
  ...
  {
    void
    operator<< (::xercesc::DOMElement&, const UidType&);

    void
    operator<< (::xercesc::DOMAttr&, const UidType&);
