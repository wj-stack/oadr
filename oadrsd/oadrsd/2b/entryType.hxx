...
#ifndef ENTRY_TYPE_HXX
#define ENTRY_TYPE_HXX
...
namespace Atom
{
  class entryType: public ::xml_schema_test::type
  {
    public:
    // author
    //
    ...
    // content
    //
    typedef ::Atom::contentType content_type;
    typedef ::xsd::cxx::tree::sequence< content_type > content_sequence;
    typedef content_sequence::iterator content_iterator;
    typedef content_sequence::const_iterator content_const_iterator;
    ...
    // published
    //
    typedef ::Atom::dateTimeType published_type;
    typedef ::xsd::cxx::tree::sequence< published_type > published_sequence;
    typedef published_sequence::iterator published_iterator;
    typedef published_sequence::const_iterator published_const_iterator;
    typedef ::xsd::cxx::tree::traits< published_type, char > published_traits;

    const published_sequence&
    published () const;
    ...
    // source
    //
    typedef ::Atom::textType source_type;
    ...
    // summary
    //
    typedef ::Atom::textType summary_type;
    typedef ::xsd::cxx::tree::sequence< summary_type > summary_sequence;
    typedef summary_sequence::iterator summary_iterator;
    typedef summary_sequence::const_iterator summary_const_iterator;
    ...
    content_sequence content_;
    contributor_sequence contributor_;
    id_sequence id_;
    link_sequence link_;
    published_sequence published_;
    rights_sequence rights_;
    source_sequence source_;
    summary_sequence summary_;
