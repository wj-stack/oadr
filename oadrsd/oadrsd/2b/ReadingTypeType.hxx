...
#ifndef READING_TYPE_TYPE_HXX
#define READING_TYPE_TYPE_HXX
...
namespace oadr2b
{
  namespace ei
  {
    class ReadingTypeType: public ::xml_schema_test::string
    {
      public:

      ReadingTypeType (const char* v);

      ReadingTypeType (const ::std::string& v);

      ReadingTypeType (const ::xercesc::DOMElement& e,
                  ::xml_schema_test::flags f = 0,
                  ::xml_schema_test::container* c = 0);

      ReadingTypeType (const ::xercesc::DOMAttr& a,
                  ::xml_schema_test::flags f = 0,
                  ::xml_schema_test::container* c = 0);

      ReadingTypeType (const ::std::string& s,
                       const ::xercesc::DOMElement* e,
                  ::xml_schema_test::flags f = 0,
                  ::xml_schema_test::container* c = 0);

      ReadingTypeType (const ReadingTypeType& x,
                  ::xml_schema_test::flags f = 0,
                  ::xml_schema_test::container* c = 0);

      virtual ReadingTypeType*
...
namespace oadr2b
{
  ...
  {
    void
    operator<< (::xercesc::DOMElement&, const ReadingTypeType&);

    void
    operator<< (::xercesc::DOMAttr&, const ReadingTypeType&);

    void
    operator<< (::xml_schema_test::list_stream&,
                const ReadingTypeType&);
  }
}
