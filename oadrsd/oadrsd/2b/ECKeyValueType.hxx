...
#ifndef ECKEY_VALUE_TYPE_HXX
#define ECKEY_VALUE_TYPE_HXX
...
namespace oadr2b
{
  namespace dsig11
  {
    class ECKeyValueType: public ::xml_schema_test::type
    {
      public:
      // ECParameters
      //
      typedef ::oadr2b::dsig11::ECParametersType ECParameters_type;
      typedef ::xsd::cxx::tree::optional< ECParameters_type > ECParameters_optional;
      typedef ::xsd::cxx::tree::traits< ECParameters_type, char > ECParameters_traits;

      const ECParameters_optional&
      ECParameters () const;

      ECParameters_optional&
      ECParameters ();
      ...
      void
      ECParameters (::std::unique_ptr< ECParameters_type > p);

      // NamedCurve
      //
      typedef ::oadr2b::dsig11::NamedCurveType NamedCurve_type;
      typedef ::xsd::cxx::tree::optional< NamedCurve_type > NamedCurve_optional;
      typedef ::xsd::cxx::tree::traits< NamedCurve_type, char > NamedCurve_traits;

      const NamedCurve_optional&
      NamedCurve () const;
      ...
      void
      NamedCurve (::std::unique_ptr< NamedCurve_type > p);

      // PublicKey
      //
      typedef ::oadr2b::dsig11::ECPointType PublicKey_type;
      typedef ::xsd::cxx::tree::traits< PublicKey_type, char > PublicKey_traits;

      const PublicKey_type&
      PublicKey () const;
      ...
      void
      PublicKey (::std::unique_ptr< PublicKey_type > p);
      ...
      // Constructors.
      //
      ECKeyValueType (const PublicKey_type&);
      ...
      protected:
      ECParameters_optional ECParameters_;
      NamedCurve_optional NamedCurve_;
      ::xsd::cxx::tree::one< PublicKey_type > PublicKey_;
      Id_optional Id_;
    };
  }
}
...
namespace oadr2b
{
  ...
  {
    void
    operator<< (::xercesc::DOMElement&, const ECKeyValueType&);
  }
}
