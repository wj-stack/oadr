...
#ifndef EI_EVENT_SIGNALS_TYPE_HXX
#define EI_EVENT_SIGNALS_TYPE_HXX
...
namespace oadr2b
{
  namespace ei
  {
    class eiEventSignalsType: public ::xml_schema_test::type
    {
      public:
      // eiEventSignal
      //
      typedef ::oadr2b::ei::eiEventSignalType eiEventSignal_type;
      typedef ::xsd::cxx::tree::sequence< eiEventSignal_type > eiEventSignal_sequence;
      typedef eiEventSignal_sequence::iterator eiEventSignal_iterator;
      typedef eiEventSignal_sequence::const_iterator eiEventSignal_const_iterator;
      typedef ::xsd::cxx::tree::traits< eiEventSignal_type, char > eiEventSignal_traits;

      const eiEventSignal_sequence&
      eiEventSignal () const;

      eiEventSignal_sequence&
      eiEventSignal ();
      ...
      // eiEventBaseline
      //
      typedef ::oadr2b::ei::eiEventBaselineType eiEventBaseline_type;
      typedef ::xsd::cxx::tree::optional< eiEventBaseline_type > eiEventBaseline_optional;
      typedef ::xsd::cxx::tree::traits< eiEventBaseline_type, char > eiEventBaseline_traits;

      const eiEventBaseline_optional&
      eiEventBaseline () const;

      eiEventBaseline_optional&
      eiEventBaseline ();
      ...
      void
      eiEventBaseline (::std::unique_ptr< eiEventBaseline_type > p);
      ...
      protected:
      eiEventSignal_sequence eiEventSignal_;
      eiEventBaseline_optional eiEventBaseline_;
    };
  }
}
...
namespace oadr2b
{
  ...
  {
    void
    operator<< (::xercesc::DOMElement&, const eiEventSignalsType&);
  }
}
...
#endif // EI_EVENT_SIGNALS_TYPE_HXX
