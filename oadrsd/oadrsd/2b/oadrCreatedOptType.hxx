...
#ifndef OADR_CREATED_OPT_TYPE_HXX
#define OADR_CREATED_OPT_TYPE_HXX
...
namespace oadr2b
{
  namespace oadr
  {
    class oadrCreatedOptType: public ::xml_schema_test::type
    {
      public:
      // eiResponse
      //
      ...
      // Constructors.
      //
      oadrCreatedOptType (const eiResponse_type&,
                          const optID_type&);

      oadrCreatedOptType (::std::unique_ptr< eiResponse_type >,
                          const optID_type&);
...
namespace oadr2b
{
  ...
  {
    void
    operator<< (::xercesc::DOMElement&, const oadrCreatedOptType&);
  }
}
...
#endif // OADR_CREATED_OPT_TYPE_HXX
