...
#ifndef PN_BFIELD_PARAMS_TYPE_HXX
#define PN_BFIELD_PARAMS_TYPE_HXX
...
namespace oadr2b
{
  namespace dsig11
  {
    class PnBFieldParamsType: public ::oadr2b::dsig11::CharTwoFieldParamsType
    {
      public:
      // K1
      //
      ...
      // Constructors.
      //
      PnBFieldParamsType (const M_type&,
                          const K1_type&,
                          const K2_type&,
                          const K3_type&);
      ...
      ::xsd::cxx::tree::one< K2_type > K2_;
      ::xsd::cxx::tree::one< K3_type > K3_;
    };
  }
}
...
namespace oadr2b
{
  ...
  {
    void
    operator<< (::xercesc::DOMElement&, const PnBFieldParamsType&);
  }
}
...
#endif // PN_BFIELD_PARAMS_TYPE_HXX
