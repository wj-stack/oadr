...
#ifndef OADR_DATA_QUALITY_TYPE_HXX
#define OADR_DATA_QUALITY_TYPE_HXX
...
namespace oadr2b
{
  namespace oadr
  {
    class oadrDataQualityType: public ::xml_schema_test::token
    {
      public:
      enum value
      {
        No_Quality___No_Value,
        No_New_Value___Previous_Value_Used,
        Quality_Bad___Non_Specific,
        Quality_Bad___Configuration_Error,
        Quality_Bad___Not_Connected,
        Quality_Bad___Device_Failure,
        Quality_Bad___Sensor_Failure,
        Quality_Bad___Last_Known_Value,
        Quality_Bad___Comm_Failure,
        Quality_Bad___Out_of_Service,
        Quality_Uncertain___Non_Specific,
        Quality_Uncertain___Last_Usable_Value,
        Quality_Uncertain___Sensor_Not_Accurate,
        Quality_Uncertain___EU_Units_Exceeded,
        Quality_Uncertain___Sub_Normal,
        Quality_Good___Non_Specific,
        Quality_Good___Local_Override,
        Quality_Limit___Field_Not,
        Quality_Limit___Field_Low,
        Quality_Limit___Field_High,
        Quality_Limit___Field_Constant
      };
      ...
      oadrDataQualityType (const oadrDataQualityType& x,
                      ::xml_schema_test::flags f = 0,
                      ::xml_schema_test::container* c = 0);

      virtual oadrDataQualityType*
      ...
      {
        return _xsd_oadrDataQualityType_convert ();
      }
...
namespace oadr2b
{
  ...
  {
    void
    operator<< (::xercesc::DOMElement&, const oadrDataQualityType&);

    void
    operator<< (::xercesc::DOMAttr&, const oadrDataQualityType&);

    void
    operator<< (::xml_schema_test::list_stream&,
                const oadrDataQualityType&);
  }
}
...
#endif // OADR_DATA_QUALITY_TYPE_HXX
