...
#ifndef OADR_SERVICE_HXX
#define OADR_SERVICE_HXX
...
namespace oadr2b
{
  namespace oadr
  {
    class oadrService: public ::xml_schema_test::type
    {
      public:
      // oadrServiceName
      //
      typedef ::oadr2b::oadr::oadrServiceNameType oadrServiceName_type;
      typedef ::xsd::cxx::tree::traits< oadrServiceName_type, char > oadrServiceName_traits;

      const oadrServiceName_type&
      oadrServiceName () const;

      oadrServiceName_type&
      oadrServiceName ();
      ...
      void
      oadrServiceName (::std::unique_ptr< oadrServiceName_type > p);
      ...
      // Constructors.
      //
      oadrService (const oadrServiceName_type&);
      ...
      protected:
      ::xsd::cxx::tree::one< oadrServiceName_type > oadrServiceName_;
...
namespace oadr2b
{
  ...
  {
    void
    operator<< (::xercesc::DOMElement&, const oadrService&);
  }
}
