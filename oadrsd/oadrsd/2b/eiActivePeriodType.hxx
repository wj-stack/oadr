...
#ifndef EI_ACTIVE_PERIOD_TYPE_HXX
#define EI_ACTIVE_PERIOD_TYPE_HXX
...
namespace oadr2b
{
  namespace ei
  {
    class eiActivePeriodType: public ::xml_schema_test::type
    {
      public:
      // properties
      //
      ...
      // components
      //
      typedef ::xml_schema_test::type components_type;
      ...
      // Constructors.
      //
      eiActivePeriodType (const properties_type&,
                          const components_type&);

      eiActivePeriodType (::std::unique_ptr< properties_type >,
                          const components_type&);
...
namespace oadr2b
{
  ...
  {
    void
    operator<< (::xercesc::DOMElement&, const eiActivePeriodType&);
  }
}
...
#endif // EI_ACTIVE_PERIOD_TYPE_HXX
