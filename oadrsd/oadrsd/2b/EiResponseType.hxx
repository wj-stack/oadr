...
#ifndef EI_RESPONSE_TYPE_HXX
#define EI_RESPONSE_TYPE_HXX
...
namespace oadr2b
{
  namespace ei
  {
    class EiResponseType: public ::xml_schema_test::type
    {
      public:
      // responseCode
      //
      ...
      // Constructors.
      //
      EiResponseType (const responseCode_type&,
                      const requestID_type&);
...
namespace oadr2b
{
  ...
  {
    void
    operator<< (::xercesc::DOMElement&, const EiResponseType&);
  }
}
