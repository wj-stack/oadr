...
#ifndef CRYPTO_BINARY_HXX
#define CRYPTO_BINARY_HXX
...
namespace oadr2b
{
  namespace sig
  {
    class CryptoBinary: public ::xml_schema_test::base64_binary
    {
      public:
      // Constructors.
      //
      ...
      CryptoBinary (const  ::xml_schema_test::base64_binary&);
