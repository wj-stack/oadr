...
#ifndef OADR_POLL_TYPE_HXX
#define OADR_POLL_TYPE_HXX
...
namespace oadr2b
{
  namespace oadr
  {
    class oadrPollType: public ::xml_schema_test::type
    {
      public:
      // venID
      //
...
namespace oadr2b
{
  ...
  {
    void
    operator<< (::xercesc::DOMElement&, const oadrPollType&);
  }
}
