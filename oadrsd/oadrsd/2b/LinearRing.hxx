...
namespace oadr2b
{
  namespace gml
  {
    class LinearRing: public ::xml_schema_test::type
    {
      public:
      // posList
      //
      typedef ::oadr2b::gml::doubleList posList_type;
      typedef ::xsd::cxx::tree::traits< posList_type, char > posList_traits;
      ...
      void
      posList (::std::unique_ptr< posList_type > p);

      // Constructors.
      //
      LinearRing (const posList_type&);
      ...
      protected:
      ::xsd::cxx::tree::one< posList_type > posList_;
    };
  }
}
...
namespace oadr2b
{
  ...
  {
    void
    operator<< (::xercesc::DOMElement&, const LinearRing&);
  }
}
