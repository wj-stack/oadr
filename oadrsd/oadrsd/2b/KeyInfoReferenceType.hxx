...
#ifndef KEY_INFO_REFERENCE_TYPE_HXX
#define KEY_INFO_REFERENCE_TYPE_HXX
...
namespace oadr2b
{
  namespace dsig11
  {
    class KeyInfoReferenceType: public ::xml_schema_test::type
    {
      public:
      // URI
      //
      ...
      // Constructors.
      //
      KeyInfoReferenceType (const URI_type&);
...
namespace oadr2b
{
  ...
  {
    void
    operator<< (::xercesc::DOMElement&, const KeyInfoReferenceType&);
  }
}
...
#endif // KEY_INFO_REFERENCE_TYPE_HXX
