...
#ifndef TRANSPORT_INTERFACE_TYPE_HXX
#define TRANSPORT_INTERFACE_TYPE_HXX
...
namespace power
{
  class TransportInterfaceType: public ::xml_schema_test::type
  {
    public:
    // pointOfReceipt
    //
    typedef ::power::NodeType pointOfReceipt_type;
    typedef ::xsd::cxx::tree::traits< pointOfReceipt_type, char > pointOfReceipt_traits;

    const pointOfReceipt_type&
    ...
    void
    pointOfReceipt (::std::unique_ptr< pointOfReceipt_type > p);

    // pointOfDelivery
    //
    typedef ::power::NodeType pointOfDelivery_type;
    typedef ::xsd::cxx::tree::traits< pointOfDelivery_type, char > pointOfDelivery_traits;

    const pointOfDelivery_type&
    pointOfDelivery () const;

    pointOfDelivery_type&
    pointOfDelivery ();
    ...
    void
    pointOfDelivery (::std::unique_ptr< pointOfDelivery_type > p);

    // Constructors.
    //
    TransportInterfaceType (const pointOfReceipt_type&,
                            const pointOfDelivery_type&);
    ...
    virtual TransportInterfaceType*
...
{
  void
  operator<< (::xercesc::DOMElement&, const TransportInterfaceType&);
}
...
#endif // TRANSPORT_INTERFACE_TYPE_HXX
