...
#ifndef OADR_UPDATED_REPORT_TYPE_HXX
#define OADR_UPDATED_REPORT_TYPE_HXX
...
namespace oadr2b
{
  namespace oadr
  {
    class oadrUpdatedReportType: public ::xml_schema_test::type
    {
      public:
      // eiResponse
      //
      ...
      // Constructors.
      //
      oadrUpdatedReportType (const eiResponse_type&);

      oadrUpdatedReportType (::std::unique_ptr< eiResponse_type >);
...
namespace oadr2b
{
  ...
  {
    void
    operator<< (::xercesc::DOMElement&, const oadrUpdatedReportType&);
  }
}
...
#endif // OADR_UPDATED_REPORT_TYPE_HXX
