...
#ifndef STREAM_PAYLOAD_BASE_TYPE_HXX
#define STREAM_PAYLOAD_BASE_TYPE_HXX
...
namespace stream
{
  class StreamPayloadBaseType: public ::xml_schema_test::type
  {
    public:
    // Constructors.
    //
...
{
  void
  operator<< (::xercesc::DOMElement&, const StreamPayloadBaseType&);
...
#endif // STREAM_PAYLOAD_BASE_TYPE_HXX
