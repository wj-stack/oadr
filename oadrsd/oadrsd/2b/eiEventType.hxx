...
#ifndef EI_EVENT_TYPE_HXX
#define EI_EVENT_TYPE_HXX
...
namespace oadr2b
{
  namespace ei
  {
    class eiEventType: public ::xml_schema_test::type
    {
      public:
      // eventDescriptor
      //
      typedef ::oadr2b::ei::eventDescriptorType eventDescriptor_type;
      typedef ::xsd::cxx::tree::traits< eventDescriptor_type, char > eventDescriptor_traits;

      const eventDescriptor_type&
      eventDescriptor () const;

      eventDescriptor_type&
      eventDescriptor ();
      ...
      void
      eventDescriptor (::std::unique_ptr< eventDescriptor_type > p);

      // eiActivePeriod
      //
      typedef ::oadr2b::ei::eiActivePeriodType eiActivePeriod_type;
      typedef ::xsd::cxx::tree::traits< eiActivePeriod_type, char > eiActivePeriod_traits;
      ...
      void
      eiActivePeriod (::std::unique_ptr< eiActivePeriod_type > p);

      // eiEventSignals
      //
      typedef ::oadr2b::ei::eiEventSignalsType eiEventSignals_type;
      typedef ::xsd::cxx::tree::traits< eiEventSignals_type, char > eiEventSignals_traits;
      ...
      void
      eiEventSignals (::std::unique_ptr< eiEventSignals_type > p);
      ...
      eiEventType (::std::unique_ptr< eventDescriptor_type >,
                   ::std::unique_ptr< eiActivePeriod_type >,
                   ::std::unique_ptr< eiEventSignals_type >,
                   ::std::unique_ptr< eiTarget_type >);
      ...
      protected:
      ::xsd::cxx::tree::one< eventDescriptor_type > eventDescriptor_;
      ::xsd::cxx::tree::one< eiActivePeriod_type > eiActivePeriod_;
...
namespace oadr2b
{
  ...
  {
    void
    operator<< (::xercesc::DOMElement&, const eiEventType&);
  }
}
