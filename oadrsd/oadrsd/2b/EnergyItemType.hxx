...
#ifndef ENERGY_ITEM_TYPE_HXX
#define ENERGY_ITEM_TYPE_HXX
...
namespace power
{
  class EnergyItemType: public ::oadr2b::emix::ItemBaseType
  {
    public:
    // itemDescription
    //
    ...
    // Constructors.
    //
    EnergyItemType (const itemDescription_type&,
                    const itemUnits_type&,
                    const siScaleCode_type&);
...
{
  void
  operator<< (::xercesc::DOMElement&, const EnergyItemType&);
}
