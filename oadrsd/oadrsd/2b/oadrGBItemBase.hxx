...
#ifndef OADR_GBITEM_BASE_HXX
#define OADR_GBITEM_BASE_HXX
...
namespace oadr2b
{
  namespace oadr
  {
    class oadrGBItemBase: public ::oadr2b::emix::ItemBaseType
    {
      public:
      // feed
      //
      ...
      // Constructors.
      //
      oadrGBItemBase (const feed_type&);

      oadrGBItemBase (::std::unique_ptr< feed_type >);
...
namespace oadr2b
{
  ...
  {
    void
    operator<< (::xercesc::DOMElement&, const oadrGBItemBase&);
  }
}
