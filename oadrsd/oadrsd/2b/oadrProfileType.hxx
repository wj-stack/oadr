...
#ifndef OADR_PROFILE_TYPE_HXX
#define OADR_PROFILE_TYPE_HXX
...
namespace oadr2b
{
  namespace oadr
  {
    class oadrProfileType: public ::xml_schema_test::token
    {
      public:
      enum value
      {
      ...
      oadrProfileType (const  ::xml_schema_test::token& v);
      ...
      oadrProfileType (const oadrProfileType& x,
                  ::xml_schema_test::flags f = 0,
                  ::xml_schema_test::container* c = 0);

      virtual oadrProfileType*
      ...
      {
        return _xsd_oadrProfileType_convert ();
      }
      ...
      public:
      static const char* const _xsd_oadrProfileType_literals_[2];
      static const value _xsd_oadrProfileType_indexes_[2];
    };
  }
}
...
namespace oadr2b
{
  ...
  {
    void
    operator<< (::xercesc::DOMElement&, const oadrProfileType&);

    void
    operator<< (::xercesc::DOMAttr&, const oadrProfileType&);

    void
    operator<< (::xml_schema_test::list_stream&,
                const oadrProfileType&);
  }
}
