...
#ifndef OADR_PAYLOAD_RESOURCE_STATUS_TYPE_HXX
#define OADR_PAYLOAD_RESOURCE_STATUS_TYPE_HXX
...
namespace oadr2b
{
  namespace oadr
  {
    class oadrPayloadResourceStatusType;
  }
}
...
namespace oadr2b
{
  namespace oadr
  {
    class oadrPayloadResourceStatusType: public ::oadr2b::ei::PayloadBaseType
    {
      public:
      // oadrOnline
      //
      typedef ::xml_schema_test::boolean oadrOnline_type;
      typedef ::xsd::cxx::tree::traits< oadrOnline_type, char > oadrOnline_traits;

      const oadrOnline_type&
      oadrOnline () const;
      ...
      // oadrManualOverride
      //
      typedef ::xml_schema_test::boolean oadrManualOverride_type;
      typedef ::xsd::cxx::tree::traits< oadrManualOverride_type, char > oadrManualOverride_traits;

      const oadrManualOverride_type&
      oadrManualOverride () const;

      oadrManualOverride_type&
      oadrManualOverride ();
      ...
      //
      typedef ::oadr2b::oadr::oadrLoadControlStateType oadrLoadControlState_type;
      typedef ::xsd::cxx::tree::optional< oadrLoadControlState_type > oadrLoadControlState_optional;
      typedef ::xsd::cxx::tree::traits< oadrLoadControlState_type, char > oadrLoadControlState_traits;

      const oadrLoadControlState_optional&
      ...
      void
      oadrLoadControlState (::std::unique_ptr< oadrLoadControlState_type > p);

      // Constructors.
      //
      oadrPayloadResourceStatusType (const oadrOnline_type&,
                                     const oadrManualOverride_type&);
      ...
      virtual oadrPayloadResourceStatusType*
      ...
      protected:
      ::xsd::cxx::tree::one< oadrOnline_type > oadrOnline_;
      ::xsd::cxx::tree::one< oadrManualOverride_type > oadrManualOverride_;
      oadrLoadControlState_optional oadrLoadControlState_;
    };
  }
}
...
namespace oadr2b
{
  ...
  {
    void
    operator<< (::xercesc::DOMElement&, const oadrPayloadResourceStatusType&);
  }
}
...
#endif // OADR_PAYLOAD_RESOURCE_STATUS_TYPE_HXX
