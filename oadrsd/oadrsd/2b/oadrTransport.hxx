...
#ifndef OADR_TRANSPORT_HXX
#define OADR_TRANSPORT_HXX
...
namespace oadr2b
{
  namespace oadr
  {
    class oadrTransport: public ::xml_schema_test::type
    {
      public:
      // oadrTransportName
      //
      ...
      // Constructors.
      //
      oadrTransport (const oadrTransportName_type&);
...
namespace oadr2b
{
  ...
  {
    void
    operator<< (::xercesc::DOMElement&, const oadrTransport&);
  }
}
