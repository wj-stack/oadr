...
#ifndef ICON_TYPE_HXX
#define ICON_TYPE_HXX
...
namespace Atom
{
  class iconType: public ::xml_schema_test::uri
  {
    public:
    // base
    //
    ...
    // Constructors.
    //
    iconType (const  ::xml_schema_test::uri&);
...
{
  void
  operator<< (::xercesc::DOMElement&, const iconType&);
}
