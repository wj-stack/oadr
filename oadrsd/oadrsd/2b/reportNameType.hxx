...
#ifndef REPORT_NAME_TYPE_HXX
#define REPORT_NAME_TYPE_HXX
...
namespace oadr2b
{
  namespace ei
  {
    class reportNameType: public ::xml_schema_test::string
    {
      public:

      reportNameType (const char* v);

      reportNameType (const ::std::string& v);

      reportNameType (const ::xercesc::DOMElement& e,
                 ::xml_schema_test::flags f = 0,
                 ::xml_schema_test::container* c = 0);

      reportNameType (const ::xercesc::DOMAttr& a,
                 ::xml_schema_test::flags f = 0,
                 ::xml_schema_test::container* c = 0);

      reportNameType (const ::std::string& s,
                      const ::xercesc::DOMElement* e,
                 ::xml_schema_test::flags f = 0,
                 ::xml_schema_test::container* c = 0);

      reportNameType (const reportNameType& x,
                 ::xml_schema_test::flags f = 0,
                 ::xml_schema_test::container* c = 0);

      virtual reportNameType*
...
namespace oadr2b
{
  ...
  {
    void
    operator<< (::xercesc::DOMElement&, const reportNameType&);

    void
    operator<< (::xercesc::DOMAttr&, const reportNameType&);

    void
    operator<< (::xml_schema_test::list_stream&,
                const reportNameType&);
  }
}
