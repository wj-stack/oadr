...
#ifndef EI_REQUEST_EVENT_HXX
#define EI_REQUEST_EVENT_HXX
...
namespace payloads
{
  class eiRequestEvent: public ::xml_schema_test::type
  {
    public:
    // requestID
    //
    ...
    // replyLimit
    //
    typedef ::xml_schema_test::unsigned_int replyLimit_type;
    typedef ::xsd::cxx::tree::optional< replyLimit_type > replyLimit_optional;
    typedef ::xsd::cxx::tree::traits< replyLimit_type, char > replyLimit_traits;

    const replyLimit_optional&
    replyLimit () const;
    ...
    // Constructors.
    //
    eiRequestEvent (const requestID_type&,
                    const venID_type&);
...
{
  void
  operator<< (::xercesc::DOMElement&, const eiRequestEvent&);
}
