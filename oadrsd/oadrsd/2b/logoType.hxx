...
#ifndef LOGO_TYPE_HXX
#define LOGO_TYPE_HXX
...
namespace Atom
{
  class logoType: public ::xml_schema_test::uri
  {
    public:
    // base
    //
    ...
    // Constructors.
    //
    logoType (const  ::xml_schema_test::uri&);
...
{
  void
  operator<< (::xercesc::DOMElement&, const logoType&);
}
