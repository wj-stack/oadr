...
namespace icalendar_2_0
{
  class tolerate: public ::xml_schema_test::type
  {
    public:
    // startafter
    //
    typedef ::icalendar_2_0::DurationValueType startafter_type;
    typedef ::xsd::cxx::tree::optional< startafter_type > startafter_optional;
    typedef ::xsd::cxx::tree::traits< startafter_type, char > startafter_traits;

    const startafter_optional&
    startafter () const;
    ...
    void
    startafter (::std::unique_ptr< startafter_type > p);
...
{
  void
  operator<< (::xercesc::DOMElement&, const tolerate&);
}
