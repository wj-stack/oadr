...
#ifndef MRID_TYPE_HXX
#define MRID_TYPE_HXX
...
namespace power
{
  class MridType: public ::xml_schema_test::string
  {
    public:
    // Constructors.
    //
    ...
    MridType (const ::std::string&);

    MridType (const  ::xml_schema_test::string&);
...
{
  void
  operator<< (::xercesc::DOMElement&, const MridType&);

  void
  operator<< (::xercesc::DOMAttr&, const MridType&);
