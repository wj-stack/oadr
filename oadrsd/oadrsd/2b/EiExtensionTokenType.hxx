...
#ifndef EI_EXTENSION_TOKEN_TYPE_HXX
#define EI_EXTENSION_TOKEN_TYPE_HXX
...
namespace oadr2b
{
  namespace ei
  {
    class EiExtensionTokenType: public ::xml_schema_test::token
    {
      public:
      // Constructors.
      //
      ...
      EiExtensionTokenType (const char*);

      EiExtensionTokenType (const ::std::string&);

      EiExtensionTokenType (const  ::xml_schema_test::token&);
...
namespace oadr2b
{
  ...
  {
    void
    operator<< (::xercesc::DOMElement&, const EiExtensionTokenType&);

    void
    operator<< (::xercesc::DOMAttr&, const EiExtensionTokenType&);

    void
    operator<< (::xml_schema_test::list_stream&,
                const EiExtensionTokenType&);
  }
}
...
#endif // EI_EXTENSION_TOKEN_TYPE_HXX
