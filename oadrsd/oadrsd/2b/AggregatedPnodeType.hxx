...
#ifndef AGGREGATED_PNODE_TYPE_HXX
#define AGGREGATED_PNODE_TYPE_HXX
...
namespace power
{
  class AggregatedPnodeType: public ::xml_schema_test::type
  {
    public:
    // node
    //
    ...
    // Constructors.
    //
    AggregatedPnodeType (const node_type&);
...
{
  void
  operator<< (::xercesc::DOMElement&, const AggregatedPnodeType&);
}
...
#endif // AGGREGATED_PNODE_TYPE_HXX
