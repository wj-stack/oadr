...
#ifndef X509DIGEST_TYPE_HXX
#define X509DIGEST_TYPE_HXX
...
namespace oadr2b
{
  namespace dsig11
  {
    class X509DigestType: public ::xml_schema_test::base64_binary
    {
      public:
      // Algorithm
      //
      typedef ::xml_schema_test::uri Algorithm_type;
      ...
      // Constructors.
      //
      X509DigestType (const Algorithm_type&);

      X509DigestType (const  ::xml_schema_test::base64_binary&,
                      const Algorithm_type&);
...
namespace oadr2b
{
  ...
  {
    void
    operator<< (::xercesc::DOMElement&, const X509DigestType&);
  }
}
