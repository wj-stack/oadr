...
#ifndef HMACOUTPUT_LENGTH_TYPE_HXX
#define HMACOUTPUT_LENGTH_TYPE_HXX
...
namespace oadr2b
{
  namespace sig
  {
    class HMACOutputLengthType: public ::xsd::cxx::tree::fundamental_base< ::xml_schema_test::integer, char, ::xml_schema_test::simple_type >
    {
      public:
      // Constructors.
      //
      HMACOutputLengthType (const  ::xml_schema_test::integer&);
...
#endif // HMACOUTPUT_LENGTH_TYPE_HXX
