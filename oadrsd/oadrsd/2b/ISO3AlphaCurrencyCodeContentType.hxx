...
#ifndef ISO3ALPHA_CURRENCY_CODE_CONTENT_TYPE_HXX
#define ISO3ALPHA_CURRENCY_CODE_CONTENT_TYPE_HXX
...
{
  class ISO3AlphaCurrencyCodeContentType;
}
...
namespace ISO42173A_2010_04_07
{
  class ISO3AlphaCurrencyCodeContentType: public ::xml_schema_test::token
  {
    public:
    enum value
    {
    ...
    ISO3AlphaCurrencyCodeContentType (const ISO3AlphaCurrencyCodeContentType& x,
                                 ::xml_schema_test::flags f = 0,
                                 ::xml_schema_test::container* c = 0);

    virtual ISO3AlphaCurrencyCodeContentType*
    ...
    {
      return _xsd_ISO3AlphaCurrencyCodeContentType_convert ();
    }
...
{
  void
  operator<< (::xercesc::DOMElement&, const ISO3AlphaCurrencyCodeContentType&);

  void
  operator<< (::xercesc::DOMAttr&, const ISO3AlphaCurrencyCodeContentType&);

  void
  operator<< (::xml_schema_test::list_stream&,
              const ISO3AlphaCurrencyCodeContentType&);
}
...
#endif // ISO3ALPHA_CURRENCY_CODE_CONTENT_TYPE_HXX
