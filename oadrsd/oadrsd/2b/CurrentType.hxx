...
#ifndef CURRENT_TYPE_HXX
#define CURRENT_TYPE_HXX
...
namespace oadr2b
{
  namespace oadr
  {
    class CurrentType: public ::oadr2b::emix::ItemBaseType
    {
      public:
      // itemDescription
      //
      ...
      // Constructors.
      //
      CurrentType (const itemDescription_type&,
                   const itemUnits_type&,
                   const siScaleCode_type&);
