...
namespace oadr2b
{
  namespace gml
  {
    class Polygon: public ::xml_schema_test::type
    {
      public:
      // exterior
      //
      typedef ::oadr2b::gml::exterior exterior_type;
      typedef ::xsd::cxx::tree::traits< exterior_type, char > exterior_traits;
      ...
      void
      exterior (::std::unique_ptr< exterior_type > p);
      ...
      // Constructors.
      //
      Polygon (const exterior_type&);

      Polygon (::std::unique_ptr< exterior_type >);
      ...
      protected:
      ::xsd::cxx::tree::one< exterior_type > exterior_;
      id_optional id_;
    };
  }
}
...
namespace oadr2b
{
  ...
  {
    void
    operator<< (::xercesc::DOMElement&, const Polygon&);
  }
}
