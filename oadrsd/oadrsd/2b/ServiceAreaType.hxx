...
#ifndef SERVICE_AREA_TYPE_HXX
#define SERVICE_AREA_TYPE_HXX
...
namespace oadr2b
{
  namespace emix
  {
    class ServiceAreaType: public ::xml_schema_test::type
    {
      public:
      // FeatureCollection
      //
      typedef ::oadr2b::gml::FeatureCollection FeatureCollection_type;
      typedef ::xsd::cxx::tree::traits< FeatureCollection_type, char > FeatureCollection_traits;

      const FeatureCollection_type&
      ...
      void
      FeatureCollection (::std::unique_ptr< FeatureCollection_type > p);

      // Constructors.
      //
      ServiceAreaType (const FeatureCollection_type&);

      ServiceAreaType (::std::unique_ptr< FeatureCollection_type >);

      ServiceAreaType (const ::xercesc::DOMElement& e,
                  ::xml_schema_test::flags f = 0,
                  ::xml_schema_test::container* c = 0);

      ServiceAreaType (const ServiceAreaType& x,
                  ::xml_schema_test::flags f = 0,
                  ::xml_schema_test::container* c = 0);

      virtual ServiceAreaType*
      _clone (::xml_schema_test::flags f = 0,
         ::xml_schema_test::container* c = 0) const;

      ServiceAreaType&
      operator= (const ServiceAreaType& x);
...
namespace oadr2b
{
  ...
  {
    void
    operator<< (::xercesc::DOMElement&, const ServiceAreaType&);
  }
}
