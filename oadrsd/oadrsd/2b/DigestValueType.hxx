...
#ifndef DIGEST_VALUE_TYPE_HXX
#define DIGEST_VALUE_TYPE_HXX
...
namespace oadr2b
{
  namespace sig
  {
    class DigestValueType: public ::xml_schema_test::base64_binary
    {
      public:
      // Constructors.
      //
      ...
      DigestValueType (const  ::xml_schema_test::base64_binary&);
