...
#ifndef RESPONSE_CODE_TYPE_HXX
#define RESPONSE_CODE_TYPE_HXX
...
namespace oadr2b
{
  namespace ei
  {
    class ResponseCodeType: public ::xml_schema_test::string
    {
      public:
      // Constructors.
      //
      ...
      ResponseCodeType (const char*);

      ResponseCodeType (const ::std::string&);

      ResponseCodeType (const  ::xml_schema_test::string&);
...
namespace oadr2b
{
  ...
  {
    void
    operator<< (::xercesc::DOMElement&, const ResponseCodeType&);

    void
    operator<< (::xercesc::DOMAttr&, const ResponseCodeType&);
