...
#ifndef METER_ASSET_TYPE_HXX
#define METER_ASSET_TYPE_HXX
...
namespace power
{
  class MeterAssetType: public ::xml_schema_test::type
  {
    public:
    // mrid
    //
    typedef ::power::MridType mrid_type;
    typedef ::xsd::cxx::tree::traits< mrid_type, char > mrid_traits;
    ...
    void
    mrid (::std::unique_ptr< mrid_type > p);

    // Constructors.
    //
    MeterAssetType (const mrid_type&);

    MeterAssetType (const ::xercesc::DOMElement& e,
               ::xml_schema_test::flags f = 0,
               ::xml_schema_test::container* c = 0);

    MeterAssetType (const MeterAssetType& x,
               ::xml_schema_test::flags f = 0,
               ::xml_schema_test::container* c = 0);

    virtual MeterAssetType*
    _clone (::xml_schema_test::flags f = 0,
       ::xml_schema_test::container* c = 0) const;

    MeterAssetType&
    operator= (const MeterAssetType& x);
...
{
  void
  operator<< (::xercesc::DOMElement&, const MeterAssetType&);
}
