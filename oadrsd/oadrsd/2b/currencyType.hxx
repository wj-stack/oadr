...
#ifndef CURRENCY_TYPE_HXX
#define CURRENCY_TYPE_HXX
...
namespace oadr2b
{
  namespace oadr
  {
    class currencyType: public ::oadr2b::emix::ItemBaseType
    {
      public:
      // itemDescription
      //
      typedef ::oadr2b::oadr::currencyItemDescriptionType itemDescription_type;
      ...
      // itemUnits
      //
      typedef ::ISO42173A_2010_04_07::ISO3AlphaCurrencyCodeContentType itemUnits_type;
      ...
      // Constructors.
      //
      currencyType (const itemDescription_type&,
                    const itemUnits_type&,
                    const siScaleCode_type&);
...
namespace oadr2b
{
  ...
  {
    void
    operator<< (::xercesc::DOMElement&, const currencyType&);
  }
}
