...
#ifndef PULSE_COUNT_TYPE_HXX
#define PULSE_COUNT_TYPE_HXX
...
namespace oadr2b
{
  namespace oadr
  {
    class pulseCountType: public ::oadr2b::emix::ItemBaseType
    {
      public:
      // itemDescription
      //
      ...
      static const itemDescription_type&
      ...
      static const itemUnits_type&
      itemUnits_default_value ();

      // pulseFactor
      //
      typedef ::xml_schema_test::float_ pulseFactor_type;
      typedef ::xsd::cxx::tree::traits< pulseFactor_type, char > pulseFactor_traits;

      const pulseFactor_type&
      pulseFactor () const;
      ...
      // Constructors.
      //
      pulseCountType (const itemDescription_type&,
                      const itemUnits_type&,
                      const pulseFactor_type&);
      ...
      static const itemDescription_type itemDescription_default_value_;
...
namespace oadr2b
{
  ...
  {
    void
    operator<< (::xercesc::DOMElement&, const pulseCountType&);
  }
}
