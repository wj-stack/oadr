...
#ifndef VOLTAGE_TYPE_HXX
#define VOLTAGE_TYPE_HXX
...
namespace power
{
  class VoltageType: public ::oadr2b::emix::ItemBaseType
  {
    public:
    // itemDescription
    //
    ...
    // Constructors.
    //
    VoltageType (const itemDescription_type&,
                 const itemUnits_type&,
                 const siScaleCode_type&);
