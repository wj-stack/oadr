...
namespace oadr2b
{
  namespace oadr
  {
    ...
    const CurrentType::itemDescription_type& CurrentType::
    itemDescription () const
    {
      return this->itemDescription_.get ();
    }

    CurrentType::itemDescription_type& CurrentType::
    itemDescription ()
    {
      return this->itemDescription_.get ();
    }
    ...
    const CurrentType::itemUnits_type& CurrentType::
    itemUnits () const
    {
      return this->itemUnits_.get ();
    }

    CurrentType::itemUnits_type& CurrentType::
    itemUnits ()
    {
      return this->itemUnits_.get ();
    }
    ...
    const CurrentType::siScaleCode_type& CurrentType::
    siScaleCode () const
    {
      return this->siScaleCode_.get ();
    }

    CurrentType::siScaleCode_type& CurrentType::
    siScaleCode ()
    {
      return this->siScaleCode_.get ();
    }
...
namespace oadr2b
{
  namespace oadr
  {
    ...
    const CurrentType::itemDescription_type CurrentType::itemDescription_default_value_ (
      "Current");

    const CurrentType::itemUnits_type CurrentType::itemUnits_default_value_ (
      "A");

    CurrentType::
    CurrentType (const itemDescription_type& itemDescription,
    ...
    static
    const ::xsd::cxx::tree::type_factory_initializer< 0, char, CurrentType >
    _xsd_CurrentType_type_factory_init (
      "CurrentType",
      "http://openadr.org/oadr-2.0b/2012/07");
  }
}
...
namespace oadr2b
{
  namespace oadr
  {
    ...
    static
    const ::xsd::cxx::tree::type_serializer_initializer< 0, char, CurrentType >
    _xsd_CurrentType_type_serializer_init (
      "CurrentType",
      "http://openadr.org/oadr-2.0b/2012/07");
  }
}
