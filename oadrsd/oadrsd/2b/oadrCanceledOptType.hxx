...
#ifndef OADR_CANCELED_OPT_TYPE_HXX
#define OADR_CANCELED_OPT_TYPE_HXX
...
namespace oadr2b
{
  namespace oadr
  {
    class oadrCanceledOptType: public ::xml_schema_test::type
    {
      public:
      // eiResponse
      //
      ...
      typedef ::xsd::cxx::tree::optional< optID_type > optID_optional;
      typedef ::xsd::cxx::tree::traits< optID_type, char > optID_traits;

      const optID_optional&
      optID () const;
      ...
      // Constructors.
      //
      oadrCanceledOptType (const eiResponse_type&);

      oadrCanceledOptType (::std::unique_ptr< eiResponse_type >);
...
namespace oadr2b
{
  ...
  {
    void
    operator<< (::xercesc::DOMElement&, const oadrCanceledOptType&);
  }
}
...
#endif // OADR_CANCELED_OPT_TYPE_HXX
