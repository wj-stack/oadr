...
#ifndef TEMPERATURE_TYPE_HXX
#define TEMPERATURE_TYPE_HXX
...
namespace oadr2b
{
  namespace oadr
  {
    class temperatureType: public ::oadr2b::emix::ItemBaseType
    {
      public:
      // itemDescription
      //
      ...
      // itemUnits
      //
      typedef ::oadr2b::oadr::temperatureUnitType itemUnits_type;
      ...
      // Constructors.
      //
      temperatureType (const itemDescription_type&,
                       const itemUnits_type&,
                       const siScaleCode_type&);
