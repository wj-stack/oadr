...
namespace oadr2b
{
  namespace oadr
  {
    ...
    const oadrTransport::oadrTransportName_type& oadrTransport::
    oadrTransportName () const
    {
      return this->oadrTransportName_.get ();
    }

    oadrTransport::oadrTransportName_type& oadrTransport::
    oadrTransportName ()
    {
      return this->oadrTransportName_.get ();
    }
...
namespace oadr2b
{
  namespace oadr
  {
    ...
    oadrTransport::
    oadrTransport (const oadrTransportName_type& oadrTransportName)
    ...
    oadrTransport::
    oadrTransport (const oadrTransport& x,
    ...
    oadrTransport::
    oadrTransport (const ::xercesc::DOMElement& e,
              ::xml_schema_test::flags f,
              ::xml_schema_test::container* c)
    ...
    {
      return new class oadrTransport (*this, f, c);
    }

    oadrTransport& oadrTransport::
    operator= (const oadrTransport& x)
    {
      if (this != &x)
      {
...
namespace oadr2b
{
  ...
  {
    void
    operator<< (::xercesc::DOMElement& e, const oadrTransport& i)
    {
