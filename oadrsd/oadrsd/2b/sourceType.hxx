...
#ifndef SOURCE_TYPE_HXX
#define SOURCE_TYPE_HXX
...
namespace Atom
{
  class sourceType: public ::xml_schema_test::type
  {
    public:
    // author
    //
...
{
  void
  operator<< (::xercesc::DOMElement&, const sourceType&);
}
