...
#ifndef OADR_REQUEST_REREGISTRATION_TYPE_HXX
#define OADR_REQUEST_REREGISTRATION_TYPE_HXX
...
namespace oadr2b
{
  namespace oadr
  {
    class oadrRequestReregistrationType: public ::xml_schema_test::type
    {
      public:
      // venID
      //
      ...
      // Constructors.
      //
      oadrRequestReregistrationType (const venID_type&);
      ...
      virtual oadrRequestReregistrationType*
...
namespace oadr2b
{
  ...
  {
    void
    operator<< (::xercesc::DOMElement&, const oadrRequestReregistrationType&);
  }
}
...
#endif // OADR_REQUEST_REREGISTRATION_TYPE_HXX
