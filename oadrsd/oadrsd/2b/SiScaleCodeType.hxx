...
#ifndef SI_SCALE_CODE_TYPE_HXX
#define SI_SCALE_CODE_TYPE_HXX
...
namespace siscale
{
  class SiScaleCodeType: public ::xml_schema_test::string
  {
    public:
    enum value
    {
    ...
    SiScaleCodeType (const SiScaleCodeType& x,
                ::xml_schema_test::flags f = 0,
                ::xml_schema_test::container* c = 0);

    virtual SiScaleCodeType*
    ...
    {
      return _xsd_SiScaleCodeType_convert ();
    }
...
{
  void
  operator<< (::xercesc::DOMElement&, const SiScaleCodeType&);

  void
  operator<< (::xercesc::DOMAttr&, const SiScaleCodeType&);

  void
  operator<< (::xml_schema_test::list_stream&,
              const SiScaleCodeType&);
}
