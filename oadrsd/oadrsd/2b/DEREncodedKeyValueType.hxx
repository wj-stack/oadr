...
#ifndef DERENCODED_KEY_VALUE_TYPE_HXX
#define DERENCODED_KEY_VALUE_TYPE_HXX
...
namespace oadr2b
{
  namespace dsig11
  {
    class DEREncodedKeyValueType: public ::xml_schema_test::base64_binary
    {
      public:
      // Id
      //
      ...
      DEREncodedKeyValueType (const  ::xml_schema_test::base64_binary&);
      ...
      virtual DEREncodedKeyValueType*
...
namespace oadr2b
{
  ...
  {
    void
    operator<< (::xercesc::DOMElement&, const DEREncodedKeyValueType&);
  }
}
...
#endif // DERENCODED_KEY_VALUE_TYPE_HXX
