...
#ifndef THERM_TYPE_HXX
#define THERM_TYPE_HXX
...
namespace oadr2b
{
  namespace oadr
  {
    class ThermType: public ::oadr2b::emix::ItemBaseType
    {
      public:
      // itemDescription
      //
      ...
      // Constructors.
      //
      ThermType (const itemDescription_type&,
                 const itemUnits_type&,
                 const siScaleCode_type&);
...
namespace oadr2b
{
  ...
  {
    void
    operator<< (::xercesc::DOMElement&, const ThermType&);
  }
}
