...
namespace oadr2b
{
  namespace ei
  {
    ...
    static
    const ::xsd::cxx::tree::type_factory_initializer< 0, char, UidType >
    _xsd_UidType_type_factory_init (
      "UidType",
...
namespace oadr2b
{
  namespace ei
  {
    ...
    static
    const ::xsd::cxx::tree::type_serializer_initializer< 0, char, UidType >
    _xsd_UidType_type_serializer_init (
      "UidType",
      "http://docs.oasis-open.org/ns/energyinterop/201110");
  }
}
