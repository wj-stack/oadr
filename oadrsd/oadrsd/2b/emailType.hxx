...
#ifndef EMAIL_TYPE_HXX
#define EMAIL_TYPE_HXX
...
namespace Atom
{
  class emailType: public ::xml_schema_test::normalized_string
  {
    public:
    // Constructors.
    //
    ...
    emailType (const  ::xml_schema_test::normalized_string&);
...
{
  void
  operator<< (::xercesc::DOMElement&, const emailType&);

  void
  operator<< (::xercesc::DOMAttr&, const emailType&);
