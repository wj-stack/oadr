...
#ifndef EVENT_RESPONSE_HXX
#define EVENT_RESPONSE_HXX
...
namespace oadr2b
{
  namespace ei
  {
    class eventResponse: public ::xml_schema_test::type
    {
      public:
      // responseCode
      //
      typedef ::oadr2b::ei::ResponseCodeType responseCode_type;
      ...
      // responseDescription
      //
      typedef ::xml_schema_test::string responseDescription_type;
      typedef ::xsd::cxx::tree::optional< responseDescription_type > responseDescription_optional;
      typedef ::xsd::cxx::tree::traits< responseDescription_type, char > responseDescription_traits;

      const responseDescription_optional&
      responseDescription () const;

      responseDescription_optional&
      responseDescription ();
      ...
      void
      responseDescription (::std::unique_ptr< responseDescription_type > p);
      ...
      // qualifiedEventID
      //
      typedef ::oadr2b::ei::QualifiedEventIDType qualifiedEventID_type;
      typedef ::xsd::cxx::tree::traits< qualifiedEventID_type, char > qualifiedEventID_traits;

      const qualifiedEventID_type&
      qualifiedEventID () const;

      qualifiedEventID_type&
      qualifiedEventID ();
      ...
      void
      qualifiedEventID (::std::unique_ptr< qualifiedEventID_type > p);
      ...
      // Constructors.
      //
      eventResponse (const responseCode_type&,
                     const requestID_type&,
                     const qualifiedEventID_type&,
                     const optType_type&);
      ...
      eventResponse (const responseCode_type&,
                     const requestID_type&,
                     ::std::unique_ptr< qualifiedEventID_type >,
                     const optType_type&);
      ...
      ::xsd::cxx::tree::one< qualifiedEventID_type > qualifiedEventID_;
...
namespace oadr2b
{
  ...
  {
    void
    operator<< (::xercesc::DOMElement&, const eventResponse&);
  }
}
