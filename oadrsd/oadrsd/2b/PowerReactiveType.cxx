...
namespace power
{
  ...
  PowerReactiveType::
  PowerReactiveType (const itemDescription_type& itemDescription,
  ...
  static
  const ::xsd::cxx::tree::type_factory_initializer< 0, char, PowerReactiveType >
  _xsd_PowerReactiveType_type_factory_init (
    "PowerReactiveType",
...
{
  void
  operator<< (::xercesc::DOMElement& e, const PowerReactiveType& i)
  {
    e << static_cast< const ::power::PowerItemType& > (i);
  }

  static
  const ::xsd::cxx::tree::type_serializer_initializer< 0, char, PowerReactiveType >
  _xsd_PowerReactiveType_type_serializer_init (
    "PowerReactiveType",
    "http://docs.oasis-open.org/ns/emix/2011/06/power");
}
