...
#ifndef ENERGY_REACTIVE_TYPE_HXX
#define ENERGY_REACTIVE_TYPE_HXX
...
namespace power
{
  class EnergyReactiveType: public ::power::EnergyItemType
  {
    public:
    // Constructors.
    //
    EnergyReactiveType (const itemDescription_type&,
...
{
  void
  operator<< (::xercesc::DOMElement&, const EnergyReactiveType&);
}
...
#endif // ENERGY_REACTIVE_TYPE_HXX
