...
#ifndef TEMPERATURE_UNIT_TYPE_HXX
#define TEMPERATURE_UNIT_TYPE_HXX
...
namespace oadr2b
{
  namespace oadr
  {
    class temperatureUnitType: public ::xml_schema_test::token
    {
      public:
      enum value
      {
      ...
      {
        return _xsd_temperatureUnitType_convert ();
      }
      ...
      public:
      static const char* const _xsd_temperatureUnitType_literals_[2];
      static const value _xsd_temperatureUnitType_indexes_[2];
    };
  }
}
...
namespace oadr2b
{
  namespace oadr
  {
    ...
    void
    operator<< (::xercesc::DOMAttr&, const temperatureUnitType&);
...
#endif // TEMPERATURE_UNIT_TYPE_HXX
