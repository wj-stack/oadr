...
#ifndef REFERENCE_TYPE_HXX
#define REFERENCE_TYPE_HXX
...
namespace oadr2b
{
  namespace sig
  {
    class ReferenceType: public ::xml_schema_test::type
    {
      public:
      // Transforms
      //
      typedef ::oadr2b::sig::TransformsType Transforms_type;
      ...
      // DigestMethod
      //
      typedef ::oadr2b::sig::DigestMethodType DigestMethod_type;
      ...
      // DigestValue
      //
      typedef ::oadr2b::sig::DigestValueType DigestValue_type;
      ...
      ReferenceType (::std::unique_ptr< DigestMethod_type >,
                     const DigestValue_type&);
