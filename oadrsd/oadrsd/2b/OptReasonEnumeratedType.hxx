...
#ifndef OPT_REASON_ENUMERATED_TYPE_HXX
#define OPT_REASON_ENUMERATED_TYPE_HXX
...
namespace oadr2b
{
  namespace ei
  {
    class OptReasonEnumeratedType: public ::xml_schema_test::token
    {
      public:
      enum value
      {
      ...
      OptReasonEnumeratedType (const OptReasonEnumeratedType& x,
                          ::xml_schema_test::flags f = 0,
                          ::xml_schema_test::container* c = 0);

      virtual OptReasonEnumeratedType*
      ...
      {
        return _xsd_OptReasonEnumeratedType_convert ();
      }
      ...
      public:
      static const char* const _xsd_OptReasonEnumeratedType_literals_[8];
      static const value _xsd_OptReasonEnumeratedType_indexes_[8];
    };
  }
}
...
namespace oadr2b
{
  ...
  {
    void
    operator<< (::xercesc::DOMElement&, const OptReasonEnumeratedType&);

    void
    operator<< (::xercesc::DOMAttr&, const OptReasonEnumeratedType&);

    void
    operator<< (::xml_schema_test::list_stream&,
                const OptReasonEnumeratedType&);
  }
}
...
#endif // OPT_REASON_ENUMERATED_TYPE_HXX
