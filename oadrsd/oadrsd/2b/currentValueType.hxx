...
#ifndef CURRENT_VALUE_TYPE_HXX
#define CURRENT_VALUE_TYPE_HXX
...
namespace oadr2b
{
  namespace ei
  {
    class currentValueType: public ::xml_schema_test::type
    {
      public:
      // payloadFloat
      //
      typedef ::oadr2b::ei::PayloadFloatType payloadFloat_type;
      typedef ::xsd::cxx::tree::traits< payloadFloat_type, char > payloadFloat_traits;

      const payloadFloat_type&
      payloadFloat () const;
      ...
      void
      payloadFloat (::std::unique_ptr< payloadFloat_type > p);

      // Constructors.
      //
      currentValueType (const payloadFloat_type&);

      currentValueType (::std::unique_ptr< payloadFloat_type >);
      ...
      protected:
      ::xsd::cxx::tree::one< payloadFloat_type > payloadFloat_;
    };
  }
}
...
namespace oadr2b
{
  ...
  {
    void
    operator<< (::xercesc::DOMElement&, const currentValueType&);
  }
}
