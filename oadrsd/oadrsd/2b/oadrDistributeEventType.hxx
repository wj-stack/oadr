...
#ifndef OADR_DISTRIBUTE_EVENT_TYPE_HXX
#define OADR_DISTRIBUTE_EVENT_TYPE_HXX
...
namespace oadr2b
{
  namespace oadr
  {
    class oadrDistributeEventType: public ::xml_schema_test::type
    {
      public:
      // eiResponse
      //
      typedef ::oadr2b::ei::EiResponseType eiResponse_type;
      typedef ::xsd::cxx::tree::optional< eiResponse_type > eiResponse_optional;
      typedef ::xsd::cxx::tree::traits< eiResponse_type, char > eiResponse_traits;

      const eiResponse_optional&
      eiResponse () const;
      ...
      // vtnID
      //
      typedef ::xml_schema_test::string vtnID_type;
      ...
      // oadrEvent
      //
      typedef ::oadr2b::oadr::oadrEvent oadrEvent_type;
      typedef ::xsd::cxx::tree::sequence< oadrEvent_type > oadrEvent_sequence;
      typedef oadrEvent_sequence::iterator oadrEvent_iterator;
      typedef oadrEvent_sequence::const_iterator oadrEvent_const_iterator;
      typedef ::xsd::cxx::tree::traits< oadrEvent_type, char > oadrEvent_traits;

      const oadrEvent_sequence&
      oadrEvent () const;
      ...
      // Constructors.
      //
      oadrDistributeEventType (const requestID_type&,
                               const vtnID_type&);
      ...
      virtual oadrDistributeEventType*
...
namespace oadr2b
{
  ...
  {
    void
    operator<< (::xercesc::DOMElement&, const oadrDistributeEventType&);
  }
}
...
#endif // OADR_DISTRIBUTE_EVENT_TYPE_HXX
