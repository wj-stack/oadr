...
#ifndef OADR_REGISTERED_REPORT_TYPE_HXX
#define OADR_REGISTERED_REPORT_TYPE_HXX
...
namespace oadr2b
{
  namespace oadr
  {
    class oadrRegisteredReportType: public ::xml_schema_test::type
    {
      public:
      // eiResponse
      //
      ...
      // oadrReportRequest
      //
      typedef ::oadr2b::oadr::oadrReportRequestType oadrReportRequest_type;
      typedef ::xsd::cxx::tree::sequence< oadrReportRequest_type > oadrReportRequest_sequence;
      typedef oadrReportRequest_sequence::iterator oadrReportRequest_iterator;
      typedef oadrReportRequest_sequence::const_iterator oadrReportRequest_const_iterator;
      typedef ::xsd::cxx::tree::traits< oadrReportRequest_type, char > oadrReportRequest_traits;

      const oadrReportRequest_sequence&
      oadrReportRequest () const;

      oadrReportRequest_sequence&
      oadrReportRequest ();
      ...
      // Constructors.
      //
      oadrRegisteredReportType (const eiResponse_type&);

      oadrRegisteredReportType (::std::unique_ptr< eiResponse_type >);

      oadrRegisteredReportType (const ::xercesc::DOMElement& e,
                           ::xml_schema_test::flags f = 0,
                           ::xml_schema_test::container* c = 0);

      oadrRegisteredReportType (const oadrRegisteredReportType& x,
                           ::xml_schema_test::flags f = 0,
                           ::xml_schema_test::container* c = 0);

      virtual oadrRegisteredReportType*
      _clone (::xml_schema_test::flags f = 0,
         ::xml_schema_test::container* c = 0) const;

      oadrRegisteredReportType&
      operator= (const oadrRegisteredReportType& x);
      ...
      oadrReportRequest_sequence oadrReportRequest_;
...
namespace oadr2b
{
  ...
  {
    void
    operator<< (::xercesc::DOMElement&, const oadrRegisteredReportType&);
  }
}
...
#endif // OADR_REGISTERED_REPORT_TYPE_HXX
