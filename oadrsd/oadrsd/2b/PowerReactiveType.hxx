...
#ifndef POWER_REACTIVE_TYPE_HXX
#define POWER_REACTIVE_TYPE_HXX
...
namespace power
{
  class PowerReactiveType: public ::power::PowerItemType
  {
    public:
    // Constructors.
    //
    PowerReactiveType (const itemDescription_type&,
...
{
  void
  operator<< (::xercesc::DOMElement&, const PowerReactiveType&);
}
