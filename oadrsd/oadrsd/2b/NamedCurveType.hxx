...
#ifndef NAMED_CURVE_TYPE_HXX
#define NAMED_CURVE_TYPE_HXX
...
namespace oadr2b
{
  namespace dsig11
  {
    class NamedCurveType: public ::xml_schema_test::type
    {
      public:
      // URI
      //
...
namespace oadr2b
{
  ...
  {
    void
    operator<< (::xercesc::DOMElement&, const NamedCurveType&);
  }
}
