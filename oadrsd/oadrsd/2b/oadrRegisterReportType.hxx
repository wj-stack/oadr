...
#ifndef OADR_REGISTER_REPORT_TYPE_HXX
#define OADR_REGISTER_REPORT_TYPE_HXX
...
namespace oadr2b
{
  namespace oadr
  {
    class oadrRegisterReportType: public ::xml_schema_test::type
    {
      public:
      // requestID
      //
      ...
      // oadrReport
      //
      typedef ::oadr2b::oadr::oadrReportType oadrReport_type;
      typedef ::xsd::cxx::tree::sequence< oadrReport_type > oadrReport_sequence;
      typedef oadrReport_sequence::iterator oadrReport_iterator;
      typedef oadrReport_sequence::const_iterator oadrReport_const_iterator;
      typedef ::xsd::cxx::tree::traits< oadrReport_type, char > oadrReport_traits;

      const oadrReport_sequence&
      oadrReport () const;
      ...
      typedef ::xsd::cxx::tree::optional< reportRequestID_type > reportRequestID_optional;
      typedef ::xsd::cxx::tree::traits< reportRequestID_type, char > reportRequestID_traits;

      const reportRequestID_optional&
      reportRequestID () const;

      reportRequestID_optional&
      reportRequestID ();
      ...
      // Constructors.
      //
      oadrRegisterReportType (const requestID_type&);
      ...
      virtual oadrRegisterReportType*
      ...
      oadrReport_sequence oadrReport_;
      venID_optional venID_;
      reportRequestID_optional reportRequestID_;
...
namespace oadr2b
{
  ...
  {
    void
    operator<< (::xercesc::DOMElement&, const oadrRegisterReportType&);
  }
}
...
#endif // OADR_REGISTER_REPORT_TYPE_HXX
