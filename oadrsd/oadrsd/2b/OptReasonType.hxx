...
#ifndef OPT_REASON_TYPE_HXX
#define OPT_REASON_TYPE_HXX
...
namespace oadr2b
{
  namespace ei
  {
    class OptReasonType: public ::xml_schema_test::string
    {
      public:

      OptReasonType (const char* v);

      OptReasonType (const ::std::string& v);
      ...
      OptReasonType (const OptReasonType& x,
                ::xml_schema_test::flags f = 0,
                ::xml_schema_test::container* c = 0);

      virtual OptReasonType*
...
namespace oadr2b
{
  ...
  {
    void
    operator<< (::xercesc::DOMElement&, const OptReasonType&);

    void
    operator<< (::xercesc::DOMAttr&, const OptReasonType&);
