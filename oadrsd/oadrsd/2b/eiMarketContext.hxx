...
#ifndef EI_MARKET_CONTEXT_HXX
#define EI_MARKET_CONTEXT_HXX
...
namespace oadr2b
{
  namespace ei
  {
    class eiMarketContext: public ::xml_schema_test::type
    {
      public:
      // marketContext
      //
      ...
      // Constructors.
      //
      eiMarketContext (const marketContext_type&);
      ...
      protected:
      ::xsd::cxx::tree::one< marketContext_type > marketContext_;
    };
  }
}
...
namespace oadr2b
{
  ...
  {
    void
    operator<< (::xercesc::DOMElement&, const eiMarketContext&);
  }
}
