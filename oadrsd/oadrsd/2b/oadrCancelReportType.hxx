...
#ifndef OADR_CANCEL_REPORT_TYPE_HXX
#define OADR_CANCEL_REPORT_TYPE_HXX
...
namespace oadr2b
{
  namespace oadr
  {
    class oadrCancelReportType: public ::xml_schema_test::type
    {
      public:
      // requestID
      //
      ...
      typedef ::xsd::cxx::tree::sequence< reportRequestID_type > reportRequestID_sequence;
      typedef reportRequestID_sequence::iterator reportRequestID_iterator;
      typedef reportRequestID_sequence::const_iterator reportRequestID_const_iterator;
      typedef ::xsd::cxx::tree::traits< reportRequestID_type, char > reportRequestID_traits;

      const reportRequestID_sequence&
      reportRequestID () const;

      reportRequestID_sequence&
      reportRequestID ();
      ...
      // reportToFollow
      //
      typedef ::xml_schema_test::boolean reportToFollow_type;
      typedef ::xsd::cxx::tree::traits< reportToFollow_type, char > reportToFollow_traits;

      const reportToFollow_type&
      ...
      // Constructors.
      //
      oadrCancelReportType (const requestID_type&,
                            const reportToFollow_type&);
      ...
      reportRequestID_sequence reportRequestID_;
      ::xsd::cxx::tree::one< reportToFollow_type > reportToFollow_;
...
namespace oadr2b
{
  ...
  {
    void
    operator<< (::xercesc::DOMElement&, const oadrCancelReportType&);
  }
}
...
#endif // OADR_CANCEL_REPORT_TYPE_HXX
