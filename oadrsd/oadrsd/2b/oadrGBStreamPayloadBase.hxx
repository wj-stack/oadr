...
#ifndef OADR_GBSTREAM_PAYLOAD_BASE_HXX
#define OADR_GBSTREAM_PAYLOAD_BASE_HXX
...
namespace oadr2b
{
  namespace oadr
  {
    class oadrGBStreamPayloadBase: public ::stream::StreamPayloadBaseType
    {
      public:
      // feed
      //
      typedef ::Atom::feedType feed_type;
      typedef ::xsd::cxx::tree::traits< feed_type, char > feed_traits;
      ...
      void
      feed (::std::unique_ptr< feed_type > p);

      // Constructors.
      //
      oadrGBStreamPayloadBase (const feed_type&);

      oadrGBStreamPayloadBase (::std::unique_ptr< feed_type >);
      ...
      virtual oadrGBStreamPayloadBase*
      ...
      protected:
      ::xsd::cxx::tree::one< feed_type > feed_;
    };
  }
}
...
namespace oadr2b
{
  ...
  {
    void
    operator<< (::xercesc::DOMElement&, const oadrGBStreamPayloadBase&);
  }
}
...
#endif // OADR_GBSTREAM_PAYLOAD_BASE_HXX
