...
#ifndef TN_BFIELD_PARAMS_TYPE_HXX
#define TN_BFIELD_PARAMS_TYPE_HXX
...
namespace oadr2b
{
  namespace dsig11
  {
    class TnBFieldParamsType: public ::oadr2b::dsig11::CharTwoFieldParamsType
    {
      public:
      // K
      //
      typedef ::xml_schema_test::positive_integer K_type;
      ...
      // Constructors.
      //
      TnBFieldParamsType (const M_type&,
                          const K_type&);
...
namespace oadr2b
{
  ...
  {
    void
    operator<< (::xercesc::DOMElement&, const TnBFieldParamsType&);
  }
}
...
#endif // TN_BFIELD_PARAMS_TYPE_HXX
