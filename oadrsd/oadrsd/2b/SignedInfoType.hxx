...
#ifndef SIGNED_INFO_TYPE_HXX
#define SIGNED_INFO_TYPE_HXX
...
namespace oadr2b
{
  namespace sig
  {
    class SignedInfoType: public ::xml_schema_test::type
    {
      public:
      // CanonicalizationMethod
      //
      typedef ::oadr2b::sig::CanonicalizationMethodType CanonicalizationMethod_type;
      ...
      // SignatureMethod
      //
      typedef ::oadr2b::sig::SignatureMethodType SignatureMethod_type;
      ...
      // Reference
      //
      typedef ::oadr2b::sig::ReferenceType Reference_type;
