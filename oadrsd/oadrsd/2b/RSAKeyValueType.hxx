...
#ifndef RSAKEY_VALUE_TYPE_HXX
#define RSAKEY_VALUE_TYPE_HXX
...
namespace oadr2b
{
  namespace sig
  {
    class RSAKeyValueType: public ::xml_schema_test::type
    {
      public:
      // Modulus
      //
      typedef ::oadr2b::sig::CryptoBinary Modulus_type;
      ...
      // Exponent
      //
      typedef ::oadr2b::sig::CryptoBinary Exponent_type;
