...
#ifndef ACCURACY_TYPE_HXX
#define ACCURACY_TYPE_HXX
...
namespace oadr2b
{
  namespace ei
  {
    class AccuracyType: public ::xsd::cxx::tree::fundamental_base< ::xml_schema_test::float_, char, ::xml_schema_test::simple_type >
    {
      public:
      // Constructors.
      //
      AccuracyType (const  ::xml_schema_test::float_&);
...
namespace oadr2b
{
  ...
  {
    void
    operator<< (::xercesc::DOMElement&, const AccuracyType&);

    void
    operator<< (::xercesc::DOMAttr&, const AccuracyType&);
