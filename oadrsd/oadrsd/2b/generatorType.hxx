...
#ifndef GENERATOR_TYPE_HXX
#define GENERATOR_TYPE_HXX
...
namespace Atom
{
  class generatorType: public ::xml_schema_test::string
  {
    public:
    // uri
    //
    ...
    // version
    //
    typedef ::xml_schema_test::string version_type;
    ...
    generatorType (const char*);

    generatorType (const ::std::string&);

    generatorType (const  ::xml_schema_test::string&);
...
{
  void
  operator<< (::xercesc::DOMElement&, const generatorType&);
}
