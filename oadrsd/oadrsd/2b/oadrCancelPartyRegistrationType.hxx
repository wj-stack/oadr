...
#ifndef OADR_CANCEL_PARTY_REGISTRATION_TYPE_HXX
#define OADR_CANCEL_PARTY_REGISTRATION_TYPE_HXX
...
namespace oadr2b
{
  namespace oadr
  {
    class oadrCancelPartyRegistrationType: public ::xml_schema_test::type
    {
      public:
      // requestID
      //
      ...
      // Constructors.
      //
      oadrCancelPartyRegistrationType (const requestID_type&,
                                       const registrationID_type&);

      oadrCancelPartyRegistrationType (const requestID_type&,
                                       ::std::unique_ptr< registrationID_type >);
      ...
      virtual oadrCancelPartyRegistrationType*
      ...
      ::xsd::cxx::tree::one< registrationID_type > registrationID_;
...
namespace oadr2b
{
  ...
  {
    void
    operator<< (::xercesc::DOMElement&, const oadrCancelPartyRegistrationType&);
  }
}
...
#endif // OADR_CANCEL_PARTY_REGISTRATION_TYPE_HXX
