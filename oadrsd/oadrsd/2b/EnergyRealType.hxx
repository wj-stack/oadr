...
#ifndef ENERGY_REAL_TYPE_HXX
#define ENERGY_REAL_TYPE_HXX
...
namespace power
{
  class EnergyRealType: public ::power::EnergyItemType
  {
    public:
    // Constructors.
    //
    EnergyRealType (const itemDescription_type&,
...
{
  void
  operator<< (::xercesc::DOMElement&, const EnergyRealType&);
}
