...
#ifndef MARKET_CONTEXT_TYPE_HXX
#define MARKET_CONTEXT_TYPE_HXX
...
namespace oadr2b
{
  namespace emix
  {
    class MarketContextType: public ::xml_schema_test::uri
    {
      public:
      // Constructors.
      //
      MarketContextType (const  ::xml_schema_test::uri&);
...
namespace oadr2b
{
  ...
  {
    void
    operator<< (::xercesc::DOMElement&, const MarketContextType&);

    void
    operator<< (::xercesc::DOMAttr&, const MarketContextType&);

    void
    operator<< (::xml_schema_test::list_stream&,
                const MarketContextType&);
  }
}
