...
#ifndef FEATURE_COLLECTION_HXX
#define FEATURE_COLLECTION_HXX
...
namespace oadr2b
{
  namespace gml
  {
    class FeatureCollection: public ::xml_schema_test::type
    {
      public:
      // location
      //
      typedef ::oadr2b::gml::location location_type;
      ...
      // Constructors.
      //
      FeatureCollection (const location_type&);

      FeatureCollection (::std::unique_ptr< location_type >);
...
namespace oadr2b
{
  ...
  {
    void
    operator<< (::xercesc::DOMElement&, const FeatureCollection&);
  }
}
