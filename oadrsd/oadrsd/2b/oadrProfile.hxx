...
#ifndef OADR_PROFILE_HXX
#define OADR_PROFILE_HXX
...
namespace oadr2b
{
  namespace oadr
  {
    class oadrProfile: public ::xml_schema_test::type
    {
      public:
      // oadrProfileName
      //
      ...
      // oadrTransports
      //
      typedef ::oadr2b::oadr::oadrTransports oadrTransports_type;
      typedef ::xsd::cxx::tree::traits< oadrTransports_type, char > oadrTransports_traits;
      ...
      void
      oadrTransports (::std::unique_ptr< oadrTransports_type > p);

      // Constructors.
      //
      oadrProfile (const oadrProfileName_type&,
                   const oadrTransports_type&);

      oadrProfile (const oadrProfileName_type&,
                   ::std::unique_ptr< oadrTransports_type >);
      ...
      ::xsd::cxx::tree::one< oadrTransports_type > oadrTransports_;
    };
  }
}
...
namespace oadr2b
{
  ...
  {
    void
    operator<< (::xercesc::DOMElement&, const oadrProfile&);
  }
}
