...
#ifndef RESPONSE_REQUIRED_TYPE_HXX
#define RESPONSE_REQUIRED_TYPE_HXX
...
namespace oadr2b
{
  namespace oadr
  {
    class ResponseRequiredType: public ::xml_schema_test::string
    {
      public:
      enum value
      {
      ...
      ResponseRequiredType (const ResponseRequiredType& x,
                       ::xml_schema_test::flags f = 0,
                       ::xml_schema_test::container* c = 0);

      virtual ResponseRequiredType*
      ...
      {
        return _xsd_ResponseRequiredType_convert ();
      }
      ...
      public:
      static const char* const _xsd_ResponseRequiredType_literals_[2];
      static const value _xsd_ResponseRequiredType_indexes_[2];
    };
  }
}
...
namespace oadr2b
{
  ...
  {
    void
    operator<< (::xercesc::DOMElement&, const ResponseRequiredType&);

    void
    operator<< (::xercesc::DOMAttr&, const ResponseRequiredType&);
...
#endif // RESPONSE_REQUIRED_TYPE_HXX
