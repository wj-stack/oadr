...
#ifndef OADR_CANCELED_REPORT_TYPE_HXX
#define OADR_CANCELED_REPORT_TYPE_HXX
...
namespace oadr2b
{
  namespace oadr
  {
    class oadrCanceledReportType: public ::xml_schema_test::type
    {
      public:
      // eiResponse
      //
      ...
      // Constructors.
      //
      oadrCanceledReportType (const eiResponse_type&,
                              const oadrPendingReports_type&);

      oadrCanceledReportType (::std::unique_ptr< eiResponse_type >,
      ...
      virtual oadrCanceledReportType*
...
namespace oadr2b
{
  ...
  {
    void
    operator<< (::xercesc::DOMElement&, const oadrCanceledReportType&);
  }
}
...
#endif // OADR_CANCELED_REPORT_TYPE_HXX
