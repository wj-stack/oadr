...
#ifndef OADR_PROFILES_HXX
#define OADR_PROFILES_HXX
...
namespace oadr2b
{
  namespace oadr
  {
    class oadrProfiles: public ::xml_schema_test::type
    {
      public:
      // oadrProfile
      //
      typedef ::oadr2b::oadr::oadrProfile oadrProfile_type;
      typedef ::xsd::cxx::tree::sequence< oadrProfile_type > oadrProfile_sequence;
      typedef oadrProfile_sequence::iterator oadrProfile_iterator;
      typedef oadrProfile_sequence::const_iterator oadrProfile_const_iterator;
      typedef ::xsd::cxx::tree::traits< oadrProfile_type, char > oadrProfile_traits;

      const oadrProfile_sequence&
      oadrProfile () const;

      oadrProfile_sequence&
      oadrProfile ();
      ...
      protected:
      oadrProfile_sequence oadrProfile_;
    };
  }
}
...
namespace oadr2b
{
  ...
  {
    void
    operator<< (::xercesc::DOMElement&, const oadrProfiles&);
  }
}
