...
#ifndef OADR_RESPONSE_TYPE_HXX
#define OADR_RESPONSE_TYPE_HXX
...
namespace oadr2b
{
  namespace oadr
  {
    class oadrResponseType: public ::xml_schema_test::type
    {
      public:
      // eiResponse
      //
      ...
      // Constructors.
      //
      oadrResponseType (const eiResponse_type&);

      oadrResponseType (::std::unique_ptr< eiResponse_type >);
...
namespace oadr2b
{
  ...
  {
    void
    operator<< (::xercesc::DOMElement&, const oadrResponseType&);
  }
}
