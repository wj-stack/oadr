...
#ifndef ECPARAMETERS_TYPE_HXX
#define ECPARAMETERS_TYPE_HXX
...
namespace oadr2b
{
  namespace dsig11
  {
    class ECParametersType: public ::xml_schema_test::type
    {
      public:
      // FieldID
      //
      typedef ::oadr2b::dsig11::FieldIDType FieldID_type;
      typedef ::xsd::cxx::tree::traits< FieldID_type, char > FieldID_traits;
      ...
      void
      FieldID (::std::unique_ptr< FieldID_type > p);

      // Curve
      //
      typedef ::oadr2b::dsig11::CurveType Curve_type;
      ...
      // Base
      //
      typedef ::oadr2b::dsig11::ECPointType Base_type;
      ...
      // Order
      //
      typedef ::oadr2b::sig::CryptoBinary Order_type;
      ...
      // CoFactor
      //
      typedef ::xml_schema_test::integer CoFactor_type;
      typedef ::xsd::cxx::tree::optional< CoFactor_type > CoFactor_optional;
      typedef ::xsd::cxx::tree::traits< CoFactor_type, char > CoFactor_traits;

      const CoFactor_optional&
      CoFactor () const;
      ...
      // ValidationData
      //
      typedef ::oadr2b::dsig11::ECValidationDataType ValidationData_type;
      typedef ::xsd::cxx::tree::optional< ValidationData_type > ValidationData_optional;
      typedef ::xsd::cxx::tree::traits< ValidationData_type, char > ValidationData_traits;

      const ValidationData_optional&
      ...
      void
      ValidationData (::std::unique_ptr< ValidationData_type > p);

      // Constructors.
      //
      ECParametersType (const FieldID_type&,
                        const Curve_type&,
                        const Base_type&,
                        const Order_type&);

      ECParametersType (::std::unique_ptr< FieldID_type >,
      ...
      protected:
      ::xsd::cxx::tree::one< FieldID_type > FieldID_;
      ::xsd::cxx::tree::one< Curve_type > Curve_;
      ::xsd::cxx::tree::one< Base_type > Base_;
      ::xsd::cxx::tree::one< Order_type > Order_;
      CoFactor_optional CoFactor_;
      ValidationData_optional ValidationData_;
    };
  }
}
...
namespace oadr2b
{
  ...
  {
    void
    operator<< (::xercesc::DOMElement&, const ECParametersType&);
  }
}
