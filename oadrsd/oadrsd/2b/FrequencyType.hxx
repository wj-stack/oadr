...
namespace oadr2b
{
  namespace oadr
  {
    class FrequencyType: public ::oadr2b::emix::ItemBaseType
    {
      public:
      // itemDescription
      //
      ...
      // Constructors.
      //
      FrequencyType (const itemDescription_type&,
                     const itemUnits_type&,
                     const siScaleCode_type&);
...
namespace oadr2b
{
  ...
  {
    void
    operator<< (::xercesc::DOMElement&, const FrequencyType&);
  }
}
