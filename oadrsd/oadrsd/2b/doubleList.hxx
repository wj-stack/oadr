...
namespace oadr2b
{
  namespace gml
  {
    class doubleList: public ::xml_schema_test::simple_type,
      public ::xsd::cxx::tree::list< ::xml_schema_test::double_, char, ::xsd::cxx::tree::schema_type::double_ >
    {
      public:
      doubleList ();
      ...
      : ::xsd::cxx::tree::list< ::xml_schema_test::double_, char, ::xsd::cxx::tree::schema_type::double_ > (begin, end, this)
      {
      }
