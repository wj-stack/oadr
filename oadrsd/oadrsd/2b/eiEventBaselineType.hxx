...
#ifndef EI_EVENT_BASELINE_TYPE_HXX
#define EI_EVENT_BASELINE_TYPE_HXX
...
namespace oadr2b
{
  namespace ei
  {
    class eiEventBaselineType: public ::xml_schema_test::type
    {
      ...
      void
      baselineID (::std::unique_ptr< baselineID_type > p);
      ...
      void
      baselineName (::std::unique_ptr< baselineName_type > p);
      ...
      // Constructors.
      //
      eiEventBaselineType (const dtstart_type&,
                           const duration_type&,
                           const intervals_type&,
                           const baselineID_type&,
                           const baselineName_type&);

      eiEventBaselineType (::std::unique_ptr< dtstart_type >,
                           ::std::unique_ptr< duration_type >,
                           ::std::unique_ptr< intervals_type >,
                           const baselineID_type&,
                           const baselineName_type&);
      ...
      ::xsd::cxx::tree::one< baselineID_type > baselineID_;
      resourceID_sequence resourceID_;
      ::xsd::cxx::tree::one< baselineName_type > baselineName_;
...
namespace oadr2b
{
  ...
  {
    void
    operator<< (::xercesc::DOMElement&, const eiEventBaselineType&);
  }
}
...
#endif // EI_EVENT_BASELINE_TYPE_HXX
