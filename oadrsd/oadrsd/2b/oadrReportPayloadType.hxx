...
#ifndef OADR_REPORT_PAYLOAD_TYPE_HXX
#define OADR_REPORT_PAYLOAD_TYPE_HXX
...
namespace oadr2b
{
  namespace oadr
  {
    class oadrReportPayloadType: public ::oadr2b::ei::ReportPayloadType
    {
      public:
      // oadrDataQuality
      //
      typedef ::oadr2b::oadr::oadrDataQualityTypeType oadrDataQuality_type;
      typedef ::xsd::cxx::tree::optional< oadrDataQuality_type > oadrDataQuality_optional;
      typedef ::xsd::cxx::tree::traits< oadrDataQuality_type, char > oadrDataQuality_traits;

      const oadrDataQuality_optional&
      oadrDataQuality () const;

      oadrDataQuality_optional&
      oadrDataQuality ();
      ...
      void
      oadrDataQuality (::std::unique_ptr< oadrDataQuality_type > p);

      // Constructors.
      //
      oadrReportPayloadType (const rID_type&,
                             const payloadBase_type&);

      /*oadrReportPayloadType (const rID_type&,
                             ::std::unique_ptr< payloadBase_type >);*/
...
namespace oadr2b
{
  ...
  {
    void
    operator<< (::xercesc::DOMElement&, const oadrReportPayloadType&);
  }
}
...
#endif // OADR_REPORT_PAYLOAD_TYPE_HXX
