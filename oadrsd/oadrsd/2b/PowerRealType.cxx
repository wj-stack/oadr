...
namespace power
{
  ...
  PowerRealType::
  PowerRealType (const itemDescription_type& itemDescription,
  ...
  static
  const ::xsd::cxx::tree::type_factory_initializer< 0, char, PowerRealType >
  _xsd_PowerRealType_type_factory_init (
    "PowerRealType",
...
{
  void
  operator<< (::xercesc::DOMElement& e, const PowerRealType& i)
  {
    e << static_cast< const ::power::PowerItemType& > (i);
  }

  static
  const ::xsd::cxx::tree::type_serializer_initializer< 0, char, PowerRealType >
  _xsd_PowerRealType_type_serializer_init (
    "PowerRealType",
    "http://docs.oasis-open.org/ns/emix/2011/06/power");
}
