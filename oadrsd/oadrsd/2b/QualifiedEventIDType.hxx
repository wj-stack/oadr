...
#ifndef QUALIFIED_EVENT_IDTYPE_HXX
#define QUALIFIED_EVENT_IDTYPE_HXX
...
namespace oadr2b
{
  namespace ei
  {
    class QualifiedEventIDType: public ::xml_schema_test::type
    {
      public:
      // eventID
      //
      ...
      // Constructors.
      //
      QualifiedEventIDType (const eventID_type&,
                            const modificationNumber_type&);
...
namespace oadr2b
{
  ...
  {
    void
    operator<< (::xercesc::DOMElement&, const QualifiedEventIDType&);
  }
}
...
#endif // QUALIFIED_EVENT_IDTYPE_HXX
