...
#ifndef OADR_CREATED_EVENT_TYPE_HXX
#define OADR_CREATED_EVENT_TYPE_HXX
...
namespace oadr2b
{
  namespace oadr
  {
    class oadrCreatedEventType: public ::xml_schema_test::type
    {
      public:
      // eiCreatedEvent
      //
      typedef ::payloads::eiCreatedEvent eiCreatedEvent_type;
      typedef ::xsd::cxx::tree::traits< eiCreatedEvent_type, char > eiCreatedEvent_traits;
      ...
      void
      eiCreatedEvent (::std::unique_ptr< eiCreatedEvent_type > p);
      ...
      // Constructors.
      //
      oadrCreatedEventType (const eiCreatedEvent_type&);

      oadrCreatedEventType (::std::unique_ptr< eiCreatedEvent_type >);
      ...
      protected:
      ::xsd::cxx::tree::one< eiCreatedEvent_type > eiCreatedEvent_;
...
namespace oadr2b
{
  ...
  {
    void
    operator<< (::xercesc::DOMElement&, const oadrCreatedEventType&);
  }
}
...
#endif // OADR_CREATED_EVENT_TYPE_HXX
