...
#ifndef SIGNAL_TYPE_ENUMERATED_TYPE_HXX
#define SIGNAL_TYPE_ENUMERATED_TYPE_HXX
...
namespace oadr2b
{
  namespace ei
  {
    class SignalTypeEnumeratedType: public ::xml_schema_test::token
    {
      public:
      enum value
      {
        ...
        priceRelative,
        setpoint,
        x_loadControlCapacity,
        x_loadControlLevelOffset,
        x_loadControlPercentOffset,
        x_loadControlSetpoint
      };
      ...
      SignalTypeEnumeratedType (const  ::xml_schema_test::token& v);
      ...
      SignalTypeEnumeratedType (const SignalTypeEnumeratedType& x,
                           ::xml_schema_test::flags f = 0,
                           ::xml_schema_test::container* c = 0);

      virtual SignalTypeEnumeratedType*
      ...
      {
        return _xsd_SignalTypeEnumeratedType_convert ();
      }
      ...
      public:
      static const char* const _xsd_SignalTypeEnumeratedType_literals_[11];
      static const value _xsd_SignalTypeEnumeratedType_indexes_[11];
    };
  }
}
...
namespace oadr2b
{
  ...
  {
    void
    operator<< (::xercesc::DOMElement&, const SignalTypeEnumeratedType&);
...
#endif // SIGNAL_TYPE_ENUMERATED_TYPE_HXX
