...
#ifndef PNODE_TYPE_HXX
#define PNODE_TYPE_HXX
...
namespace power
{
  class PnodeType: public ::xml_schema_test::type
  {
    public:
    // node
    //
...
{
  void
  operator<< (::xercesc::DOMElement&, const PnodeType&);
}
