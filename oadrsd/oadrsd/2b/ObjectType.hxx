...
#ifndef OBJECT_TYPE_HXX
#define OBJECT_TYPE_HXX
...
namespace oadr2b
{
  namespace sig
  {
    class ObjectType: public ::xml_schema_test::type
    {
      public:
      // Id
      //
      ...
      // MimeType
      //
      typedef ::xml_schema_test::string MimeType_type;
      ...
      // Encoding
      //
      typedef ::xml_schema_test::uri Encoding_type;
