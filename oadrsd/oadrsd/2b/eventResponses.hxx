...
#ifndef EVENT_RESPONSES_HXX
#define EVENT_RESPONSES_HXX
...
namespace oadr2b
{
  namespace ei
  {
    class eventResponses: public ::xml_schema_test::type
    {
      public:
      // eventResponse
      //
      typedef ::oadr2b::ei::eventResponse eventResponse_type;
      typedef ::xsd::cxx::tree::sequence< eventResponse_type > eventResponse_sequence;
      typedef eventResponse_sequence::iterator eventResponse_iterator;
      typedef eventResponse_sequence::const_iterator eventResponse_const_iterator;
      typedef ::xsd::cxx::tree::traits< eventResponse_type, char > eventResponse_traits;

      const eventResponse_sequence&
      eventResponse () const;

      eventResponse_sequence&
      eventResponse ();
      ...
      protected:
      eventResponse_sequence eventResponse_;
    };
  }
}
...
namespace oadr2b
{
  ...
  {
    void
    operator<< (::xercesc::DOMElement&, const eventResponses&);
  }
}
