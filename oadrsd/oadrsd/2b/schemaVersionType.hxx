...
#ifndef SCHEMA_VERSION_TYPE_HXX
#define SCHEMA_VERSION_TYPE_HXX
...
namespace oadr2b
{
  namespace ei
  {
    class schemaVersionType: public ::xml_schema_test::string
    {
      public:

      schemaVersionType (const char* v);

      schemaVersionType (const ::std::string& v);
      ...
      schemaVersionType (const schemaVersionType& x,
                    ::xml_schema_test::flags f = 0,
                    ::xml_schema_test::container* c = 0);

      virtual schemaVersionType*
...
namespace oadr2b
{
  ...
  {
    void
    operator<< (::xercesc::DOMElement&, const schemaVersionType&);

    void
    operator<< (::xercesc::DOMAttr&, const schemaVersionType&);
