...
#ifndef CHAR_TWO_FIELD_PARAMS_TYPE_HXX
#define CHAR_TWO_FIELD_PARAMS_TYPE_HXX
...
namespace oadr2b
{
  namespace dsig11
  {
    class CharTwoFieldParamsType: public ::xml_schema_test::type
    {
      public:
      // M
      //
      typedef ::xml_schema_test::positive_integer M_type;
      ...
      // Constructors.
      //
      CharTwoFieldParamsType (const M_type&);
      ...
      virtual CharTwoFieldParamsType*
...
namespace oadr2b
{
  ...
  {
    void
    operator<< (::xercesc::DOMElement&, const CharTwoFieldParamsType&);
  }
}
...
#endif // CHAR_TWO_FIELD_PARAMS_TYPE_HXX
