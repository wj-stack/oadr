...
namespace oadr2b
{
  namespace gml
  {
    class exterior: public ::xml_schema_test::type
    {
      public:
      // LinearRing
      //
      typedef ::oadr2b::gml::LinearRing LinearRing_type;
      typedef ::xsd::cxx::tree::traits< LinearRing_type, char > LinearRing_traits;

      const LinearRing_type&
      LinearRing () const;
      ...
      void
      LinearRing (::std::unique_ptr< LinearRing_type > p);

      // Constructors.
      //
      exterior (const LinearRing_type&);

      exterior (::std::unique_ptr< LinearRing_type >);
      ...
      protected:
      ::xsd::cxx::tree::one< LinearRing_type > LinearRing_;
    };
  }
}
...
namespace oadr2b
{
  ...
  {
    void
    operator<< (::xercesc::DOMElement&, const exterior&);
  }
}
