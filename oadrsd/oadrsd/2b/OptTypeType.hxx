...
#ifndef OPT_TYPE_TYPE_HXX
#define OPT_TYPE_TYPE_HXX
...
namespace oadr2b
{
  namespace ei
  {
    class OptTypeType: public ::xml_schema_test::token
    {
      public:
      enum value
      {
      ...
      OptTypeType (const OptTypeType& x,
              ::xml_schema_test::flags f = 0,
              ::xml_schema_test::container* c = 0);
      ...
      {
        return _xsd_OptTypeType_convert ();
      }

      protected:
      value
      _xsd_OptTypeType_convert () const;

      public:
      static const char* const _xsd_OptTypeType_literals_[2];
      static const value _xsd_OptTypeType_indexes_[2];
    };
  }
}
...
namespace oadr2b
{
  ...
  {
    void
    operator<< (::xercesc::DOMElement&, const OptTypeType&);

    void
    operator<< (::xercesc::DOMAttr&, const OptTypeType&);
