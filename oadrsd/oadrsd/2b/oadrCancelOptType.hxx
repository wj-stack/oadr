...
#ifndef OADR_CANCEL_OPT_TYPE_HXX
#define OADR_CANCEL_OPT_TYPE_HXX
...
namespace oadr2b
{
  namespace oadr
  {
    class oadrCancelOptType: public ::xml_schema_test::type
    {
      public:
      // requestID
      //
      ...
      // Constructors.
      //
      oadrCancelOptType (const requestID_type&,
                         const optID_type&,
                         const venID_type&);
...
namespace oadr2b
{
  ...
  {
    void
    operator<< (::xercesc::DOMElement&, const oadrCancelOptType&);
  }
}
...
#endif // OADR_CANCEL_OPT_TYPE_HXX
