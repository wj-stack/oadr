...
#ifndef SPKIDATA_TYPE_HXX
#define SPKIDATA_TYPE_HXX
...
namespace oadr2b
{
  namespace sig
  {
    class SPKIDataType: public ::xml_schema_test::type
    {
      public:
      // SPKISexp
      //
      typedef ::xml_schema_test::base64_binary SPKISexp_type;
