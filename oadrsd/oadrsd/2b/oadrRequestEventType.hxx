...
#ifndef OADR_REQUEST_EVENT_TYPE_HXX
#define OADR_REQUEST_EVENT_TYPE_HXX
...
namespace oadr2b
{
  namespace oadr
  {
    class oadrRequestEventType: public ::xml_schema_test::type
    {
      public:
      // eiRequestEvent
      //
      typedef ::payloads::eiRequestEvent eiRequestEvent_type;
      typedef ::xsd::cxx::tree::traits< eiRequestEvent_type, char > eiRequestEvent_traits;

      const eiRequestEvent_type&
      ...
      void
      eiRequestEvent (::std::unique_ptr< eiRequestEvent_type > p);
      ...
      // Constructors.
      //
      oadrRequestEventType (const eiRequestEvent_type&);

      oadrRequestEventType (::std::unique_ptr< eiRequestEvent_type >);
      ...
      protected:
      ::xsd::cxx::tree::one< eiRequestEvent_type > eiRequestEvent_;
...
namespace oadr2b
{
  ...
  {
    void
    operator<< (::xercesc::DOMElement&, const oadrRequestEventType&);
  }
}
...
#endif // OADR_REQUEST_EVENT_TYPE_HXX
