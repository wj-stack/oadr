...
#ifndef OADR_CREATE_REPORT_TYPE_HXX
#define OADR_CREATE_REPORT_TYPE_HXX
...
namespace oadr2b
{
  namespace oadr
  {
    class oadrCreateReportType: public ::xml_schema_test::type
    {
      public:
      // requestID
      //
      ...
      // Constructors.
      //
      oadrCreateReportType (const requestID_type&);
...
namespace oadr2b
{
  ...
  {
    void
    operator<< (::xercesc::DOMElement&, const oadrCreateReportType&);
  }
}
...
#endif // OADR_CREATE_REPORT_TYPE_HXX
