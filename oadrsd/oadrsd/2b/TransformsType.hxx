...
#ifndef TRANSFORMS_TYPE_HXX
#define TRANSFORMS_TYPE_HXX
...
namespace oadr2b
{
  namespace sig
  {
    class TransformsType: public ::xml_schema_test::type
    {
      public:
      // Transform
      //
      typedef ::oadr2b::sig::TransformType Transform_type;
