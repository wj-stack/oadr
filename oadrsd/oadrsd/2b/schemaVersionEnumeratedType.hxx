...
#ifndef SCHEMA_VERSION_ENUMERATED_TYPE_HXX
#define SCHEMA_VERSION_ENUMERATED_TYPE_HXX
...
namespace oadr2b
{
  namespace ei
  {
    class schemaVersionEnumeratedType;
  }
}
...
namespace oadr2b
{
  namespace ei
  {
    class schemaVersionEnumeratedType: public ::xml_schema_test::token
    {
      public:
      enum value
      {
      ...
      schemaVersionEnumeratedType (const  ::xml_schema_test::token& v);
      ...
      schemaVersionEnumeratedType (const schemaVersionEnumeratedType& x,
                              ::xml_schema_test::flags f = 0,
                              ::xml_schema_test::container* c = 0);

      virtual schemaVersionEnumeratedType*
      ...
      {
        return _xsd_schemaVersionEnumeratedType_convert ();
      }
      ...
      public:
      static const char* const _xsd_schemaVersionEnumeratedType_literals_[2];
      static const value _xsd_schemaVersionEnumeratedType_indexes_[2];
    };
  }
}
...
namespace oadr2b
{
  ...
  {
    void
    operator<< (::xercesc::DOMElement&, const schemaVersionEnumeratedType&);

    void
    operator<< (::xercesc::DOMAttr&, const schemaVersionEnumeratedType&);

    void
    operator<< (::xml_schema_test::list_stream&,
                const schemaVersionEnumeratedType&);
  }
}
...
#endif // SCHEMA_VERSION_ENUMERATED_TYPE_HXX
