...
#ifndef OADR_CREATED_REPORT_TYPE_HXX
#define OADR_CREATED_REPORT_TYPE_HXX
...
namespace oadr2b
{
  namespace oadr
  {
    class oadrCreatedReportType: public ::xml_schema_test::type
    {
      public:
      // eiResponse
      //
      ...
      // oadrPendingReports
      //
      typedef ::oadr2b::oadr::oadrPendingReportsType oadrPendingReports_type;
      typedef ::xsd::cxx::tree::traits< oadrPendingReports_type, char > oadrPendingReports_traits;

      const oadrPendingReports_type&
      oadrPendingReports () const;

      oadrPendingReports_type&
      oadrPendingReports ();
      ...
      void
      oadrPendingReports (::std::unique_ptr< oadrPendingReports_type > p);
      ...
      // Constructors.
      //
      oadrCreatedReportType (const eiResponse_type&,
                             const oadrPendingReports_type&);

      oadrCreatedReportType (::std::unique_ptr< eiResponse_type >,
                             ::std::unique_ptr< oadrPendingReports_type >);
      ...
      ::xsd::cxx::tree::one< oadrPendingReports_type > oadrPendingReports_;
...
namespace oadr2b
{
  ...
  {
    void
    operator<< (::xercesc::DOMElement&, const oadrCreatedReportType&);
  }
}
...
#endif // OADR_CREATED_REPORT_TYPE_HXX
