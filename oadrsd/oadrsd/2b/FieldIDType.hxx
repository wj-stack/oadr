...
#ifndef FIELD_IDTYPE_HXX
#define FIELD_IDTYPE_HXX
...
namespace oadr2b
{
  namespace dsig11
  {
    class FieldIDType: public ::xml_schema_test::type
    {
      public:
      // Prime
      //
      typedef ::oadr2b::dsig11::PrimeFieldParamsType Prime_type;
      typedef ::xsd::cxx::tree::optional< Prime_type > Prime_optional;
      typedef ::xsd::cxx::tree::traits< Prime_type, char > Prime_traits;

      const Prime_optional&
      Prime () const;
      ...
      void
      Prime (::std::unique_ptr< Prime_type > p);

      // TnB
      //
      typedef ::oadr2b::dsig11::TnBFieldParamsType TnB_type;
      typedef ::xsd::cxx::tree::optional< TnB_type > TnB_optional;
      typedef ::xsd::cxx::tree::traits< TnB_type, char > TnB_traits;
      ...
      void
      TnB (::std::unique_ptr< TnB_type > p);

      // PnB
      //
      typedef ::oadr2b::dsig11::PnBFieldParamsType PnB_type;
      typedef ::xsd::cxx::tree::optional< PnB_type > PnB_optional;
      typedef ::xsd::cxx::tree::traits< PnB_type, char > PnB_traits;
      ...
      void
      PnB (::std::unique_ptr< PnB_type > p);

      // GnB
      //
      typedef ::oadr2b::dsig11::CharTwoFieldParamsType GnB_type;
      typedef ::xsd::cxx::tree::optional< GnB_type > GnB_optional;
      typedef ::xsd::cxx::tree::traits< GnB_type, char > GnB_traits;
...
namespace oadr2b
{
  ...
  {
    void
    operator<< (::xercesc::DOMElement&, const FieldIDType&);
  }
}
