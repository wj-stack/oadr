...
#ifndef ARRAYOF_RESPONSES_HXX
#define ARRAYOF_RESPONSES_HXX
...
namespace oadr2b
{
  namespace ei
  {
    class ArrayofResponses: public ::xml_schema_test::type
    {
      public:
      // response
      //
      typedef ::oadr2b::ei::EiResponseType response_type;
//      typedef std::vector< response_type > response_sequence;
        typedef ::xsd::cxx::tree::sequence< response_type > response_sequence; // change to vector
      typedef response_sequence::iterator response_iterator;
      typedef response_sequence::const_iterator response_const_iterator;
//        typedef std::vector< response_type >::const_iterator response_const_iterator;
...
namespace oadr2b
{
  ...
  {
    void
    operator<< (::xercesc::DOMElement&, const ArrayofResponses&);
  }
}
