...
#ifndef PRIME_FIELD_PARAMS_TYPE_HXX
#define PRIME_FIELD_PARAMS_TYPE_HXX
...
namespace oadr2b
{
  namespace dsig11
  {
    class PrimeFieldParamsType: public ::xml_schema_test::type
    {
      public:
      // P
      //
      ...
      // Constructors.
      //
      PrimeFieldParamsType (const P_type&);
...
namespace oadr2b
{
  ...
  {
    void
    operator<< (::xercesc::DOMElement&, const PrimeFieldParamsType&);
  }
}
...
#endif // PRIME_FIELD_PARAMS_TYPE_HXX
