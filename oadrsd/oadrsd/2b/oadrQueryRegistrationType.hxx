...
#ifndef OADR_QUERY_REGISTRATION_TYPE_HXX
#define OADR_QUERY_REGISTRATION_TYPE_HXX
...
namespace oadr2b
{
  namespace oadr
  {
    class oadrQueryRegistrationType: public ::xml_schema_test::type
    {
      public:
      // requestID
      //
      ...
      // Constructors.
      //
      oadrQueryRegistrationType (const requestID_type&);
      ...
      virtual oadrQueryRegistrationType*
...
namespace oadr2b
{
  ...
  {
    void
    operator<< (::xercesc::DOMElement&, const oadrQueryRegistrationType&);
  }
}
...
#endif // OADR_QUERY_REGISTRATION_TYPE_HXX
