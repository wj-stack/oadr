...
namespace oadr2b
{
  namespace emix
  {
    ...
    const ServiceAreaType::FeatureCollection_type& ServiceAreaType::
    FeatureCollection () const
    {
      return this->FeatureCollection_.get ();
    }

    ServiceAreaType::FeatureCollection_type& ServiceAreaType::
    FeatureCollection ()
    {
      return this->FeatureCollection_.get ();
    }

    void ServiceAreaType::
...
namespace oadr2b
{
  namespace emix
  {
    ...
    ServiceAreaType::
    ServiceAreaType (const FeatureCollection_type& FeatureCollection)
    ...
    ServiceAreaType::
    ServiceAreaType (::std::unique_ptr< FeatureCollection_type > FeatureCollection)
    : ::xml_schema_test::type (),
    ...
    {
      return new class ServiceAreaType (*this, f, c);
    }
...
namespace oadr2b
{
  ...
  {
    void
    operator<< (::xercesc::DOMElement& e, const ServiceAreaType& i)
    {
