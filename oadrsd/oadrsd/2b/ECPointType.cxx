...
namespace oadr2b
{
  ...
  {
    void
    operator<< (::xercesc::DOMElement& e, const ECPointType& i)
    {
      e << static_cast< const ::oadr2b::sig::CryptoBinary& > (i);
    }

    void
    operator<< (::xercesc::DOMAttr& a, const ECPointType& i)
    {
      a << static_cast< const ::oadr2b::sig::CryptoBinary& > (i);
    }
