...
#ifndef OADR_SAMPLING_RATE_TYPE_HXX
#define OADR_SAMPLING_RATE_TYPE_HXX
...
namespace oadr2b
{
  namespace oadr
  {
    class oadrSamplingRateType: public ::xml_schema_test::type
    {
      ...
      // oadrMinPeriod
      //
      typedef ::icalendar_2_0::DurationValueType oadrMinPeriod_type;
      typedef ::xsd::cxx::tree::traits< oadrMinPeriod_type, char > oadrMinPeriod_traits;

      const oadrMinPeriod_type&
      oadrMinPeriod () const;
      ...
      void
      oadrMinPeriod (::std::unique_ptr< oadrMinPeriod_type > p);

      // oadrMaxPeriod
      //
      typedef ::icalendar_2_0::DurationValueType oadrMaxPeriod_type;
      typedef ::xsd::cxx::tree::traits< oadrMaxPeriod_type, char > oadrMaxPeriod_traits;

      const oadrMaxPeriod_type&
      oadrMaxPeriod () const;
      ...
      void
      oadrMaxPeriod (::std::unique_ptr< oadrMaxPeriod_type > p);
      ...
      // Constructors.
      //
      oadrSamplingRateType (const oadrMinPeriod_type&,
                            const oadrMaxPeriod_type&,
                            const oadrOnChange_type&);
      ...
      ::xsd::cxx::tree::one< oadrMaxPeriod_type > oadrMaxPeriod_;
      ::xsd::cxx::tree::one< oadrOnChange_type > oadrOnChange_;
    };
  }
}
...
namespace oadr2b
{
  ...
  {
    void
    operator<< (::xercesc::DOMElement&, const oadrSamplingRateType&);
  }
}
...
#endif // OADR_SAMPLING_RATE_TYPE_HXX
