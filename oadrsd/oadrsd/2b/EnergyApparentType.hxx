...
#ifndef ENERGY_APPARENT_TYPE_HXX
#define ENERGY_APPARENT_TYPE_HXX
...
namespace power
{
  class EnergyApparentType: public ::power::EnergyItemType
  {
    public:
    // Constructors.
    //
    EnergyApparentType (const itemDescription_type&,
...
{
  void
  operator<< (::xercesc::DOMElement&, const EnergyApparentType&);
}
...
#endif // ENERGY_APPARENT_TYPE_HXX
