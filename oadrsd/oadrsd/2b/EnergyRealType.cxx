...
namespace power
{
  ...
  EnergyRealType::
  EnergyRealType (const itemDescription_type& itemDescription,
  ...
  static
  const ::xsd::cxx::tree::type_factory_initializer< 0, char, EnergyRealType >
  _xsd_EnergyRealType_type_factory_init (
    "EnergyRealType",
...
{
  void
  operator<< (::xercesc::DOMElement& e, const EnergyRealType& i)
  {
    e << static_cast< const ::power::EnergyItemType& > (i);
  }

  static
  const ::xsd::cxx::tree::type_serializer_initializer< 0, char, EnergyRealType >
  _xsd_EnergyRealType_type_serializer_init (
    "EnergyRealType",
    "http://docs.oasis-open.org/ns/emix/2011/06/power");
}
