...
#ifndef POWER_REAL_TYPE_HXX
#define POWER_REAL_TYPE_HXX
...
namespace power
{
  class PowerRealType: public ::power::PowerItemType
  {
    public:
    // Constructors.
    //
    PowerRealType (const itemDescription_type&,
...
{
  void
  operator<< (::xercesc::DOMElement&, const PowerRealType&);
}
