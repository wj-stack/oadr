...
#ifndef TOLERANCE_HXX
#define TOLERANCE_HXX
...
namespace icalendar_2_0
{
  class tolerance: public ::xml_schema_test::type
  {
    public:
    // tolerate
    //
    typedef ::icalendar_2_0::tolerate tolerate_type;
    typedef ::xsd::cxx::tree::traits< tolerate_type, char > tolerate_traits;
    ...
    void
    tolerate (::std::unique_ptr< tolerate_type > p);

    // Constructors.
    //
    tolerance (const tolerate_type&);

    tolerance (::std::unique_ptr< tolerate_type >);
    ...
    protected:
    ::xsd::cxx::tree::one< tolerate_type > tolerate_;
  };
}
...
{
  void
  operator<< (::xercesc::DOMElement&, const tolerance&);
}
