...
#ifndef POWER_APPARENT_TYPE_HXX
#define POWER_APPARENT_TYPE_HXX
...
namespace power
{
  class PowerApparentType: public ::power::PowerItemType
  {
    public:
    // Constructors.
    //
    PowerApparentType (const itemDescription_type&,
...
{
  void
  operator<< (::xercesc::DOMElement&, const PowerApparentType&);
}
