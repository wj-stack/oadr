...
#ifndef SIGNAL_NAME_TYPE_HXX
#define SIGNAL_NAME_TYPE_HXX
...
namespace oadr2b
{
  namespace ei
  {
    class signalNameType: public ::xml_schema_test::string
    {
      public:

      signalNameType (const char* v);

      signalNameType (const ::std::string& v);

      signalNameType (const ::xercesc::DOMElement& e,
                 ::xml_schema_test::flags f = 0,
                 ::xml_schema_test::container* c = 0);

      signalNameType (const ::xercesc::DOMAttr& a,
                 ::xml_schema_test::flags f = 0,
                 ::xml_schema_test::container* c = 0);

      signalNameType (const ::std::string& s,
                      const ::xercesc::DOMElement* e,
                 ::xml_schema_test::flags f = 0,
                 ::xml_schema_test::container* c = 0);

      signalNameType (const signalNameType& x,
                 ::xml_schema_test::flags f = 0,
                 ::xml_schema_test::container* c = 0);

      virtual signalNameType*
...
namespace oadr2b
{
  ...
  {
    void
    operator<< (::xercesc::DOMElement&, const signalNameType&);

    void
    operator<< (::xercesc::DOMAttr&, const signalNameType&);

    void
    operator<< (::xml_schema_test::list_stream&,
                const signalNameType&);
  }
}
