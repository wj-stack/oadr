...
#ifndef OADR_SERVICE_SPECIFIC_INFO_HXX
#define OADR_SERVICE_SPECIFIC_INFO_HXX
...
namespace oadr2b
{
  namespace oadr
  {
    class oadrServiceSpecificInfo: public ::xml_schema_test::type
    {
      public:
      // oadrService
      //
      typedef ::oadr2b::oadr::oadrService oadrService_type;
      typedef ::xsd::cxx::tree::sequence< oadrService_type > oadrService_sequence;
      typedef oadrService_sequence::iterator oadrService_iterator;
      typedef oadrService_sequence::const_iterator oadrService_const_iterator;
      typedef ::xsd::cxx::tree::traits< oadrService_type, char > oadrService_traits;

      const oadrService_sequence&
      oadrService () const;

      oadrService_sequence&
      oadrService ();
      ...
      virtual oadrServiceSpecificInfo*
      ...
      protected:
      oadrService_sequence oadrService_;
    };
  }
}
...
namespace oadr2b
{
  ...
  {
    void
    operator<< (::xercesc::DOMElement&, const oadrServiceSpecificInfo&);
  }
}
...
#endif // OADR_SERVICE_SPECIFIC_INFO_HXX
