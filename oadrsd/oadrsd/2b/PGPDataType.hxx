...
#ifndef PGPDATA_TYPE_HXX
#define PGPDATA_TYPE_HXX
...
namespace oadr2b
{
  namespace sig
  {
    class PGPDataType: public ::xml_schema_test::type
    {
      public:
      // PGPKeyID
      //
      typedef ::xml_schema_test::base64_binary PGPKeyID_type;
      ...
      // PGPKeyPacket
      //
      typedef ::xml_schema_test::base64_binary PGPKeyPacket_type;
