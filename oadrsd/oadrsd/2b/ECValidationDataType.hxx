...
#ifndef ECVALIDATION_DATA_TYPE_HXX
...
namespace oadr2b
{
  namespace dsig11
  {
    class ECValidationDataType: public ::xml_schema_test::type
    {
      public:
      // seed
      //
      ...
      // hashAlgorithm
      //
      typedef ::xml_schema_test::uri hashAlgorithm_type;
      typedef ::xsd::cxx::tree::traits< hashAlgorithm_type, char > hashAlgorithm_traits;

      const hashAlgorithm_type&
      hashAlgorithm () const;
      ...
      void
      hashAlgorithm (::std::unique_ptr< hashAlgorithm_type > p);

      // Constructors.
      //
      ECValidationDataType (const seed_type&,
                            const hashAlgorithm_type&);
...
namespace oadr2b
{
  ...
  {
    void
    operator<< (::xercesc::DOMElement&, const ECValidationDataType&);
  }
}
...
#endif // ECVALIDATION_DATA_TYPE_HXX
