...
#ifndef ITEM_BASE_TYPE_HXX
#define ITEM_BASE_TYPE_HXX
...
namespace oadr2b
{
  namespace emix
  {
    class ItemBaseType: public ::xml_schema_test::type
    {
      public:
      // Constructors.
      //
...
namespace oadr2b
{
  ...
  {
    void
    operator<< (::xercesc::DOMElement&, const ItemBaseType&);
