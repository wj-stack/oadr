...
#ifndef OADR_REPORT_REQUEST_TYPE_HXX
#define OADR_REPORT_REQUEST_TYPE_HXX
...
namespace oadr2b
{
  namespace oadr
  {
    class oadrReportRequestType: public ::xml_schema_test::type
    {
      public:
      // reportRequestID
      //
      ...
      // reportSpecifier
      //
      typedef ::oadr2b::ei::ReportSpecifierType reportSpecifier_type;
      typedef ::xsd::cxx::tree::traits< reportSpecifier_type, char > reportSpecifier_traits;

      const reportSpecifier_type&
      reportSpecifier () const;

      reportSpecifier_type&
      reportSpecifier ();
      ...
      void
      reportSpecifier (::std::unique_ptr< reportSpecifier_type > p);

      // Constructors.
      //
      oadrReportRequestType (const reportRequestID_type&,
                             const reportSpecifier_type&);

      oadrReportRequestType (const reportRequestID_type&,
                             ::std::unique_ptr< reportSpecifier_type >);
      ...
      ::xsd::cxx::tree::one< reportSpecifier_type > reportSpecifier_;
    };
  }
}
...
namespace oadr2b
{
  ...
  {
    void
    operator<< (::xercesc::DOMElement&, const oadrReportRequestType&);
  }
}
...
#endif // OADR_REPORT_REQUEST_TYPE_HXX
