...
#ifndef SERVICE_DELIVERY_POINT_TYPE_HXX
#define SERVICE_DELIVERY_POINT_TYPE_HXX
...
namespace power
{
  class ServiceDeliveryPointType: public ::xml_schema_test::type
  {
    public:
    // node
    //
    typedef ::power::NodeType node_type;
    ...
    // Constructors.
    //
    ServiceDeliveryPointType (const node_type&);
    ...
    virtual ServiceDeliveryPointType*
...
{
  void
  operator<< (::xercesc::DOMElement&, const ServiceDeliveryPointType&);
}
...
#endif // SERVICE_DELIVERY_POINT_TYPE_HXX
