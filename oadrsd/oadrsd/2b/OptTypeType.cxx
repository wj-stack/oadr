...
namespace oadr2b
{
  namespace ei
  {
    ...
    OptTypeType::value OptTypeType::
    _xsd_OptTypeType_convert () const
    {
      ::xsd::cxx::tree::enum_comparator< char > c (_xsd_OptTypeType_literals_);
      const value* i (::std::lower_bound (
                        _xsd_OptTypeType_indexes_,
                        _xsd_OptTypeType_indexes_ + 2,
                        *this,
                        c));

      if (i == _xsd_OptTypeType_indexes_ + 2 || _xsd_OptTypeType_literals_[*i] != *this)
      {
    ...
    const char* const OptTypeType::
    _xsd_OptTypeType_literals_[2] =
    {
      "optIn",
      "optOut"
    };

    const OptTypeType::value OptTypeType::
    _xsd_OptTypeType_indexes_[2] =
    {
      ::oadr2b::ei::OptTypeType::optIn,
      ::oadr2b::ei::OptTypeType::optOut
    };
  }
}
