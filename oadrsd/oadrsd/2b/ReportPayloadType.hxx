...
#ifndef REPORT_PAYLOAD_TYPE_HXX
#define REPORT_PAYLOAD_TYPE_HXX
...
namespace oadr2b
{
  namespace ei
  {
    class ReportPayloadType: public ::stream::StreamPayloadBaseType
    {
      public:
      // rID
      //
      typedef ::xml_schema_test::string rID_type;
      ...
      // confidence
      //
      typedef ::oadr2b::ei::ConfidenceType confidence_type;
      ...
      void
      confidence (::std::unique_ptr< confidence_type > p);

      // accuracy
      //
      typedef ::oadr2b::ei::AccuracyType accuracy_type;
      ...
      void
      payloadBase (::std::unique_ptr< payloadBase_type > p);

      // Constructors.
      //
      ReportPayloadType (const rID_type&,
                         const payloadBase_type&);
...
namespace oadr2b
{
  ...
  {
    void
    operator<< (::xercesc::DOMElement&, const ReportPayloadType&);
  }
}
