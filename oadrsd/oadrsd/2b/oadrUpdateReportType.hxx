...
#ifndef OADR_UPDATE_REPORT_TYPE_HXX
#define OADR_UPDATE_REPORT_TYPE_HXX
...
namespace oadr2b
{
  namespace oadr
  {
    class oadrUpdateReportType: public ::xml_schema_test::type
    {
      public:
      // requestID
      //
      ...
      // Constructors.
      //
      oadrUpdateReportType (const requestID_type&);
...
namespace oadr2b
{
  ...
  {
    void
    operator<< (::xercesc::DOMElement&, const oadrUpdateReportType&);
  }
}
...
#endif // OADR_UPDATE_REPORT_TYPE_HXX
