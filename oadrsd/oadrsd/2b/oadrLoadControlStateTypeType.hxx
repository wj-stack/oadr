...
#ifndef OADR_LOAD_CONTROL_STATE_TYPE_TYPE_HXX
#define OADR_LOAD_CONTROL_STATE_TYPE_TYPE_HXX
...
namespace oadr2b
{
  namespace oadr
  {
    class oadrLoadControlStateTypeType: public ::xml_schema_test::type
    {
      ...
      oadrMax_optional oadrMax_;
      ::xsd::cxx::tree::one< oadrCurrent_type > oadrCurrent_;
      oadrNormal_optional oadrNormal_;
    };
  }
}
...
namespace oadr2b
{
  ...
  {
    void
    operator<< (::xercesc::DOMElement&, const oadrLoadControlStateTypeType&);
  }
}
...
#endif // OADR_LOAD_CONTROL_STATE_TYPE_TYPE_HXX
