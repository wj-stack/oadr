...
#ifndef DURATION_VALUE_TYPE_HXX
#define DURATION_VALUE_TYPE_HXX
...
namespace icalendar_2_0
{
  class DurationValueType: public ::xml_schema_test::string
  {
    public:
    // Constructors.
    //
    ...
    DurationValueType (const  ::xml_schema_test::string&);
