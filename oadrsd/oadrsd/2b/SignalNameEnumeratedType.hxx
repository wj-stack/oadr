...
#ifndef SIGNAL_NAME_ENUMERATED_TYPE_HXX
#define SIGNAL_NAME_ENUMERATED_TYPE_HXX
...
namespace oadr2b
{
  namespace ei
  {
    class SignalNameEnumeratedType;
  }
}
...
namespace oadr2b
{
  namespace ei
  {
    class SignalNameEnumeratedType: public ::xml_schema_test::token
    {
      public:
      enum value
      {
      ...
      SignalNameEnumeratedType (const SignalNameEnumeratedType& x,
                           ::xml_schema_test::flags f = 0,
                           ::xml_schema_test::container* c = 0);

      virtual SignalNameEnumeratedType*
      ...
      {
        return _xsd_SignalNameEnumeratedType_convert ();
      }
...
namespace oadr2b
{
  ...
  {
    void
    operator<< (::xercesc::DOMElement&, const SignalNameEnumeratedType&);

    void
    operator<< (::xercesc::DOMAttr&, const SignalNameEnumeratedType&);
...
#endif // SIGNAL_NAME_ENUMERATED_TYPE_HXX
