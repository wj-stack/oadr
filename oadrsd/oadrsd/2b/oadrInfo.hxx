...
#ifndef OADR_INFO_HXX
#define OADR_INFO_HXX
...
namespace oadr2b
{
  namespace oadr
  {
    class oadrInfo: public ::xml_schema_test::type
    {
      public:
      // oadrKey
      //
      typedef ::xml_schema_test::string oadrKey_type;
      typedef ::xsd::cxx::tree::traits< oadrKey_type, char > oadrKey_traits;
      ...
      void
      oadrKey (::std::unique_ptr< oadrKey_type > p);

      // oadrValue
      //
      typedef ::xml_schema_test::string oadrValue_type;
      typedef ::xsd::cxx::tree::traits< oadrValue_type, char > oadrValue_traits;

      const oadrValue_type&
      oadrValue () const;
      ...
      void
      oadrValue (::std::unique_ptr< oadrValue_type > p);

      // Constructors.
      //
      oadrInfo (const oadrKey_type&,
                const oadrValue_type&);
      ...
      protected:
      ::xsd::cxx::tree::one< oadrKey_type > oadrKey_;
      ::xsd::cxx::tree::one< oadrValue_type > oadrValue_;
    };
  }
}
...
namespace oadr2b
{
  ...
  {
    void
    operator<< (::xercesc::DOMElement&, const oadrInfo&);
  }
}
