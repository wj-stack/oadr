...
time_t
DateTimeConverter::DateTimeToTime_t(icalendar_2_0::dtstart::date_time_type dt) {
  struct tm tm_utc;
...
icalendar_2_0::dtstart::date_time_type
DateTimeConverter::Time_tToDateTime(time_t t) {
  struct tm parts;
  ...
  icalendar_2_0::dtstart::date_time_type dt(::xml_schema_test::date_time(
